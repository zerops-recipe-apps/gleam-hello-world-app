...
-file("/var/www/build/packages/gleam_erlang/src/gleam/erlang/charlist.gleam", 14).
-spec to_string(charlist()) -> binary().
to_string(A) ->
    unicode:characters_to_binary(A).

-file("/var/www/build/packages/gleam_erlang/src/gleam/erlang/charlist.gleam", 22).
