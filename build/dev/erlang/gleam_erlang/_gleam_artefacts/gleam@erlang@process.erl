...
-opaque subject(IGL) :: {subject, pid_(), gleam@erlang:reference_()} |
    {gleam_phantom, IGL}.

-type do_not_leak() :: any().

-type selector(IGM) :: any() | {gleam_phantom, IGM}.
...
-type call_error(IGN) :: {callee_down, gleam@dynamic:dynamic_()} |
    call_timeout |
    {gleam_phantom, IGN}.
...
-file("/var/www/build/packages/gleam_erlang/src/gleam/erlang/process.gleam", 14).
-spec self() -> pid_().
self() ->
    erlang:self().

-file("/var/www/build/packages/gleam_erlang/src/gleam/erlang/process.gleam", 28).
...
-file("/var/www/build/packages/gleam_erlang/src/gleam/erlang/process.gleam", 70).
-spec new_subject() -> subject(any()).
new_subject() ->
    {subject, erlang:self(), erlang:make_ref()}.

-file("/var/www/build/packages/gleam_erlang/src/gleam/erlang/process.gleam", 77).
-spec subject_owner(subject(any())) -> pid_().
subject_owner(Subject) ->
    erlang:element(2, Subject).

-file("/var/www/build/packages/gleam_erlang/src/gleam/erlang/process.gleam", 110).
-spec send(subject(IGW), IGW) -> nil.
...
-file("/var/www/build/packages/gleam_erlang/src/gleam/erlang/process.gleam", 166).
-spec new_selector() -> selector(any()).
new_selector() ->
    gleam_erlang_ffi:new_selector().

-file("/var/www/build/packages/gleam_erlang/src/gleam/erlang/process.gleam", 186).
-spec select(selector(IHE), integer()) -> {ok, IHE} | {error, nil}.
select(From, Within) ->
    gleam_erlang_ffi:select(From, Within).

-file("/var/www/build/packages/gleam_erlang/src/gleam/erlang/process.gleam", 195).
-spec select_forever(selector(IHI)) -> IHI.
select_forever(From) ->
    gleam_erlang_ffi:select(From).

-file("/var/www/build/packages/gleam_erlang/src/gleam/erlang/process.gleam", 204).
-spec map_selector(selector(IHK), fun((IHK) -> IHM)) -> selector(IHM).
map_selector(A, B) ->
    gleam_erlang_ffi:map_selector(A, B).

-file("/var/www/build/packages/gleam_erlang/src/gleam/erlang/process.gleam", 213).
-spec merge_selector(selector(IHO), selector(IHO)) -> selector(IHO).
merge_selector(A, B) ->
    gleam_erlang_ffi:merge_selector(A, B).

-file("/var/www/build/packages/gleam_erlang/src/gleam/erlang/process.gleam", 257).
-spec flush_messages() -> nil.
flush_messages() ->
    gleam_erlang_ffi:flush_messages().

-file("/var/www/build/packages/gleam_erlang/src/gleam/erlang/process.gleam", 229).
-spec selecting_trapped_exits(selector(IHS), fun((exit_message()) -> IHS)) -> selector(IHS).
...
-file("/var/www/build/packages/gleam_erlang/src/gleam/erlang/process.gleam", 267).
-spec selecting(selector(IHV), subject(IHX), fun((IHX) -> IHV)) -> selector(IHV).
...
-file("/var/www/build/packages/gleam_erlang/src/gleam/erlang/process.gleam", 130).
-spec 'receive'(subject(IGY), integer()) -> {ok, IGY} | {error, nil}.
'receive'(Subject, Timeout) ->
    _pipe = gleam_erlang_ffi:new_selector(),
    _pipe@1 = selecting(_pipe, Subject, fun(X) -> X end),
    gleam_erlang_ffi:select(_pipe@1, Timeout).

-file("/var/www/build/packages/gleam_erlang/src/gleam/erlang/process.gleam", 283).
-spec selecting_record2(
    selector(IIA),
    any(),
    fun((gleam@dynamic:dynamic_()) -> IIA)
) -> selector(IIA).
selecting_record2(Selector, Tag, Transform) ->
    Handler = fun(Message) -> Transform(erlang:element(2, Message)) end,
    gleam_erlang_ffi:insert_selector_handler(Selector, {Tag, 2}, Handler).

-file("/var/www/build/packages/gleam_erlang/src/gleam/erlang/process.gleam", 299).
-spec selecting_record3(
    selector(IIE),
    any(),
    fun((gleam@dynamic:dynamic_(), gleam@dynamic:dynamic_()) -> IIE)
) -> selector(IIE).
...
-file("/var/www/build/packages/gleam_erlang/src/gleam/erlang/process.gleam", 317).
-spec selecting_record4(
    selector(III),
    any(),
    fun((gleam@dynamic:dynamic_(), gleam@dynamic:dynamic_(), gleam@dynamic:dynamic_()) -> III)
) -> selector(III).
...
-file("/var/www/build/packages/gleam_erlang/src/gleam/erlang/process.gleam", 335).
-spec selecting_record5(
    selector(IIM),
    any(),
    fun((gleam@dynamic:dynamic_(), gleam@dynamic:dynamic_(), gleam@dynamic:dynamic_(), gleam@dynamic:dynamic_()) -> IIM)
) -> selector(IIM).
...
-file("/var/www/build/packages/gleam_erlang/src/gleam/erlang/process.gleam", 353).
-spec selecting_record6(
    selector(IIQ),
    any(),
    fun((gleam@dynamic:dynamic_(), gleam@dynamic:dynamic_(), gleam@dynamic:dynamic_(), gleam@dynamic:dynamic_(), gleam@dynamic:dynamic_()) -> IIQ)
) -> selector(IIQ).
...
-file("/var/www/build/packages/gleam_erlang/src/gleam/erlang/process.gleam", 371).
-spec selecting_record7(
    selector(IIU),
    any(),
    fun((gleam@dynamic:dynamic_(), gleam@dynamic:dynamic_(), gleam@dynamic:dynamic_(), gleam@dynamic:dynamic_(), gleam@dynamic:dynamic_(), gleam@dynamic:dynamic_()) -> IIU)
) -> selector(IIU).
...
-file("/var/www/build/packages/gleam_erlang/src/gleam/erlang/process.gleam", 392).
-spec selecting_record8(
    selector(IIY),
    any(),
    fun((gleam@dynamic:dynamic_(), gleam@dynamic:dynamic_(), gleam@dynamic:dynamic_(), gleam@dynamic:dynamic_(), gleam@dynamic:dynamic_(), gleam@dynamic:dynamic_(), gleam@dynamic:dynamic_()) -> IIY)
) -> selector(IIY).
...
-file("/var/www/build/packages/gleam_erlang/src/gleam/erlang/process.gleam", 442).
-spec selecting_anything(selector(IJC), fun((gleam@dynamic:dynamic_()) -> IJC)) -> selector(IJC).
selecting_anything(Selector, Handler) ->
    gleam_erlang_ffi:insert_selector_handler(Selector, anything, Handler).

-file("/var/www/build/packages/gleam_erlang/src/gleam/erlang/process.gleam", 466).
-spec sleep(integer()) -> nil.
sleep(A) ->
    gleam_erlang_ffi:sleep(A).

-file("/var/www/build/packages/gleam_erlang/src/gleam/erlang/process.gleam", 473).
-spec sleep_forever() -> nil.
sleep_forever() ->
    gleam_erlang_ffi:sleep_forever().

-file("/var/www/build/packages/gleam_erlang/src/gleam/erlang/process.gleam", 482).
-spec is_alive(pid_()) -> boolean().
is_alive(A) ->
    erlang:is_process_alive(A).

-file("/var/www/build/packages/gleam_erlang/src/gleam/erlang/process.gleam", 513).
...
-file("/var/www/build/packages/gleam_erlang/src/gleam/erlang/process.gleam", 524).
-spec selecting_process_down(
    selector(IJO),
    process_monitor(),
    fun((process_down()) -> IJO)
) -> selector(IJO).
...
-file("/var/www/build/packages/gleam_erlang/src/gleam/erlang/process.gleam", 539).
-spec demonitor_process(process_monitor()) -> nil.
demonitor_process(Monitor) ->
    gleam_erlang_ffi:demonitor(Monitor).

-file("/var/www/build/packages/gleam_erlang/src/gleam/erlang/process.gleam", 558).
-spec deselecting_process_down(selector(IJR), process_monitor()) -> selector(IJR).
...
-file("/var/www/build/packages/gleam_erlang/src/gleam/erlang/process.gleam", 573).
-spec try_call(subject(IJU), fun((subject(IJW)) -> IJU), integer()) -> {ok, IJW} |
    {error, call_error(IJW)}.
...
-file("/var/www/build/packages/gleam_erlang/src/gleam/erlang/process.gleam", 614).
-spec call(subject(IKB), fun((subject(IKD)) -> IKB), integer()) -> IKD.
...
-file("/var/www/build/packages/gleam_erlang/src/gleam/erlang/process.gleam", 633).
-spec link(pid_()) -> boolean().
link(Pid) ->
    gleam_erlang_ffi:link(Pid).

-file("/var/www/build/packages/gleam_erlang/src/gleam/erlang/process.gleam", 640).
-spec unlink(pid_()) -> nil.
unlink(Pid) ->
    erlang:unlink(Pid),
    nil.

-file("/var/www/build/packages/gleam_erlang/src/gleam/erlang/process.gleam", 652).
-spec send_after(subject(IKG), integer(), IKG) -> timer().
...
-file("/var/www/build/packages/gleam_erlang/src/gleam/erlang/process.gleam", 676).
...
-file("/var/www/build/packages/gleam_erlang/src/gleam/erlang/process.gleam", 700).
-spec kill(pid_()) -> nil.
kill(Pid) ->
    erlang:exit(Pid, kill),
    nil.

-file("/var/www/build/packages/gleam_erlang/src/gleam/erlang/process.gleam", 716).
-spec send_exit(pid_()) -> nil.
send_exit(Pid) ->
    erlang:exit(Pid, normal),
    nil.

-file("/var/www/build/packages/gleam_erlang/src/gleam/erlang/process.gleam", 728).
-spec send_abnormal_exit(pid_(), binary()) -> nil.
send_abnormal_exit(Pid, Reason) ->
    erlang:exit(Pid, {abnormal, Reason}),
    nil.

-file("/var/www/build/packages/gleam_erlang/src/gleam/erlang/process.gleam", 744).
-spec trap_exits(boolean()) -> nil.
trap_exits(A) ->
    gleam_erlang_ffi:trap_exits(A).

-file("/var/www/build/packages/gleam_erlang/src/gleam/erlang/process.gleam", 756).
-spec register(pid_(), gleam@erlang@atom:atom_()) -> {ok, nil} | {error, nil}.
register(Pid, Name) ->
    gleam_erlang_ffi:register_process(Pid, Name).

-file("/var/www/build/packages/gleam_erlang/src/gleam/erlang/process.gleam", 767).
-spec unregister(gleam@erlang@atom:atom_()) -> {ok, nil} | {error, nil}.
unregister(Name) ->
    gleam_erlang_ffi:unregister_process(Name).

-file("/var/www/build/packages/gleam_erlang/src/gleam/erlang/process.gleam", 772).
-spec named(gleam@erlang@atom:atom_()) -> {ok, pid_()} | {error, nil}.
named(Name) ->
    gleam_erlang_ffi:process_named(Name).

-file("/var/www/build/packages/gleam_erlang/src/gleam/erlang/process.gleam", 790).
