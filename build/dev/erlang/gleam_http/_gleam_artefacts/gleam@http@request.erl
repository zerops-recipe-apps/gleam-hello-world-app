...
-file("/var/www/build/packages/gleam_http/src/gleam/http/request.gleam", 31).
...
-file("/var/www/build/packages/gleam_http/src/gleam/http/request.gleam", 45).
...
-file("/var/www/build/packages/gleam_http/src/gleam/http/request.gleam", 76).
...
-file("/var/www/build/packages/gleam_http/src/gleam/http/request.gleam", 87).
-spec set_header(request(JHX), binary(), binary()) -> request(JHX).
...
-file("/var/www/build/packages/gleam_http/src/gleam/http/request.gleam", 104).
-spec prepend_header(request(JIA), binary(), binary()) -> request(JIA).
prepend_header(Request, Key, Value) ->
    Headers = [{gleam@string:lowercase(Key), Value} |
        erlang:element(3, Request)],
    erlang:setelement(3, Request, Headers).

-file("/var/www/build/packages/gleam_http/src/gleam/http/request.gleam", 116).
-spec set_body(request(any()), JIF) -> request(JIF).
set_body(Req, Body) ->
    {request, Method, Headers, _, Scheme, Host, Port, Path, Query} = Req,
    {request, Method, Headers, Body, Scheme, Host, Port, Path, Query}.

-file("/var/www/build/packages/gleam_http/src/gleam/http/request.gleam", 141).
-spec map(request(JIH), fun((JIH) -> JIJ)) -> request(JIJ).
map(Request, Transform) ->
    _pipe = erlang:element(4, Request),
    _pipe@1 = Transform(_pipe),
    set_body(Request, _pipe@1).

-file("/var/www/build/packages/gleam_http/src/gleam/http/request.gleam", 161).
...
-file("/var/www/build/packages/gleam_http/src/gleam/http/request.gleam", 167).
...
-file("/var/www/build/packages/gleam_http/src/gleam/http/request.gleam", 177).
-spec set_query(request(JIT), list({binary(), binary()})) -> request(JIT).
set_query(Req, Query) ->
    Pair = fun(T) ->
...
-file("/var/www/build/packages/gleam_http/src/gleam/http/request.gleam", 200).
-spec set_method(request(JIX), gleam@http:method()) -> request(JIX).
set_method(Req, Method) ->
    erlang:setelement(2, Req, Method).

-file("/var/www/build/packages/gleam_http/src/gleam/http/request.gleam", 207).
...
-file("/var/www/build/packages/gleam_http/src/gleam/http/request.gleam", 222).
...
-file("/var/www/build/packages/gleam_http/src/gleam/http/request.gleam", 230).
-spec set_scheme(request(JJE), gleam@http:scheme()) -> request(JJE).
set_scheme(Req, Scheme) ->
    erlang:setelement(5, Req, Scheme).

-file("/var/www/build/packages/gleam_http/src/gleam/http/request.gleam", 236).
-spec set_host(request(JJH), binary()) -> request(JJH).
set_host(Req, Host) ->
    erlang:setelement(6, Req, Host).

-file("/var/www/build/packages/gleam_http/src/gleam/http/request.gleam", 242).
-spec set_port(request(JJK), integer()) -> request(JJK).
set_port(Req, Port) ->
    erlang:setelement(7, Req, {some, Port}).

-file("/var/www/build/packages/gleam_http/src/gleam/http/request.gleam", 248).
-spec set_path(request(JJN), binary()) -> request(JJN).
set_path(Req, Path) ->
    erlang:setelement(8, Req, Path).

-file("/var/www/build/packages/gleam_http/src/gleam/http/request.gleam", 255).
-spec set_cookie(request(JJQ), binary(), binary()) -> request(JJQ).
...
-file("/var/www/build/packages/gleam_http/src/gleam/http/request.gleam", 274).
...
-file("/var/www/build/packages/gleam_http/src/gleam/http/request.gleam", 292).
-spec remove_cookie(request(JJV), binary()) -> request(JJV).
