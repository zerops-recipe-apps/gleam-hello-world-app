...
-file("/var/www/build/packages/mist/src/mist/internal/http2/stream.gleam", 148).
-spec make_request(
    list({binary(), binary()}),
...
-file("/var/www/build/packages/mist/src/mist/internal/http2/stream.gleam", 56).
-spec new(
...
-file("/var/www/build/packages/mist/src/mist/internal/http2/stream.gleam", 201).
