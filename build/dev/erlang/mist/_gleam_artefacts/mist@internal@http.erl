...
-file("/var/www/build/packages/mist/src/mist/internal/http.gleam", 76).
...
-file("/var/www/build/packages/mist/src/mist/internal/http.gleam", 111).
-spec read_data(
    glisten@socket:socket(),
    glisten@transport:transport(),
...
-file("/var/www/build/packages/mist/src/mist/internal/http.gleam", 238).
...
-file("/var/www/build/packages/mist/src/mist/internal/http.gleam", 510).
-spec add_date_header(gleam@http@response:response(TXF)) -> gleam@http@response:response(TXF).
...
-file("/var/www/build/packages/mist/src/mist/internal/http.gleam", 517).
-spec connection_close(gleam@http@response:response(TXI)) -> gleam@http@response:response(TXI).
...
-file("/var/www/build/packages/mist/src/mist/internal/http.gleam", 521).
-spec keep_alive(gleam@http@response:response(TXL)) -> gleam@http@response:response(TXL).
keep_alive(Resp) ->
    gleam@http@response:set_header(
        Resp,
        <<"connection"/utf8>>,
...
-file("/var/www/build/packages/mist/src/mist/internal/http.gleam", 525).
-spec maybe_keep_alive(gleam@http@response:response(TXO)) -> gleam@http@response:response(TXO).
...
-file("/var/www/build/packages/mist/src/mist/internal/http.gleam", 532).
-spec add_content_length(boolean(), integer()) -> fun((gleam@http@response:response(TXR)) -> gleam@http@response:response(TXR)).
...
-file("/var/www/build/packages/mist/src/mist/internal/http.gleam", 552).
...
-file("/var/www/build/packages/mist/src/mist/internal/http.gleam", 573).
...
-file("/var/www/build/packages/mist/src/mist/internal/http.gleam", 581).
...
-file("/var/www/build/packages/mist/src/mist/internal/http.gleam", 82).
-spec parse_headers(
    bitstring(),
    glisten@socket:socket(),
    glisten@transport:transport(),
...
-file("/var/www/build/packages/mist/src/mist/internal/http.gleam", 602).
-spec crypto_hash(sha_hash(), binary()) -> binary().
crypto_hash(Hash, Data) ->
    crypto:hash(Hash, Data).

-file("/var/www/build/packages/mist/src/mist/internal/http.gleam", 605).
-spec base64_encode(binary()) -> binary().
base64_encode(Data) ->
    base64:encode(Data).

-file("/var/www/build/packages/mist/src/mist/internal/http.gleam", 144).
...
-file("/var/www/build/packages/mist/src/mist/internal/http.gleam", 251).
...
-file("/var/www/build/packages/mist/src/mist/internal/http.gleam", 174).
-spec read_chunk(
    glisten@socket:socket(),
    glisten@transport:transport(),
    mist@internal@buffer:buffer(),
...
-file("/var/www/build/packages/mist/src/mist/internal/http.gleam", 357).
...
-file("/var/www/build/packages/mist/src/mist/internal/http.gleam", 440).
...
-file("/var/www/build/packages/mist/src/mist/internal/http.gleam", 447).
...
-file("/var/www/build/packages/mist/src/mist/internal/http.gleam", 487).
-spec upgrade(
    glisten@socket:socket(),
    glisten@transport:transport(),
    list(binary()),
