...
-opaque builder(WEW, WEX) :: {builder,
        integer(),
        fun((gleam@http@request:request(WEW)) -> gleam@http@response:response(WEX)),
...
-type websocket_message(WEY) :: {text, binary()} |
    {binary, bitstring()} |
    closed |
    shutdown |
    {custom, WEY}.
...
-file("/var/www/build/packages/mist/src/mist.gleam", 60).
...
-file("/var/www/build/packages/mist/src/mist.gleam", 67).
...
-file("/var/www/build/packages/mist/src/mist.gleam", 56).
...
-file("/var/www/build/packages/mist/src/mist.gleam", 79).
...
-file("/var/www/build/packages/mist/src/mist.gleam", 115).
...
-file("/var/www/build/packages/mist/src/mist.gleam", 129).
...
-file("/var/www/build/packages/mist/src/mist.gleam", 159).
-spec read_body(
...
-file("/var/www/build/packages/mist/src/mist.gleam", 188).
-spec do_stream(
    gleam@http@request:request(mist@internal@http:connection()),
    mist@internal@buffer:buffer()
) -> fun((integer()) -> {ok, chunk()} | {error, read_error()}).
...
-file("/var/www/build/packages/mist/src/mist.gleam", 253).
...
-file("/var/www/build/packages/mist/src/mist.gleam", 233).
...
-file("/var/www/build/packages/mist/src/mist.gleam", 305).
...
-file("/var/www/build/packages/mist/src/mist.gleam", 356).
-spec new(
    fun((gleam@http@request:request(WFV)) -> gleam@http@response:response(WFX))
) -> builder(WFV, WFX).
new(Handler) ->
    {builder,
        4000,
...
-file("/var/www/build/packages/mist/src/mist.gleam", 380).
-spec port(builder(WGB, WGC), integer()) -> builder(WGB, WGC).
port(Builder, Port) ->
    erlang:setelement(2, Builder, Port).

-file("/var/www/build/packages/mist/src/mist.gleam", 387).
-spec read_request_body(
    builder(bitstring(), WGH),
    integer(),
    gleam@http@response:response(WGH)
) -> builder(mist@internal@http:connection(), WGH).
...
-file("/var/www/build/packages/mist/src/mist.gleam", 409).
-spec after_start(
    builder(WGN, WGO),
    fun((integer(), gleam@http:scheme(), ip_address()) -> nil)
) -> builder(WGN, WGO).
...
-file("/var/www/build/packages/mist/src/mist.gleam", 420).
-spec bind(builder(WGT, WGU), binary()) -> builder(WGT, WGU).
bind(Builder, Interface) ->
    erlang:setelement(5, Builder, Interface).

-file("/var/www/build/packages/mist/src/mist.gleam", 429).
-spec with_ipv6(builder(WGZ, WHA)) -> builder(WGZ, WHA).
with_ipv6(Builder) ->
    erlang:setelement(6, Builder, true).

-file("/var/www/build/packages/mist/src/mist.gleam", 433).
...
-file("/var/www/build/packages/mist/src/mist.gleam", 459).
...
-file("/var/www/build/packages/mist/src/mist.gleam", 463).
-spec get_port(server()) -> integer().
get_port(Server) ->
    erlang:element(3, Server).

-file("/var/www/build/packages/mist/src/mist.gleam", 478).
...
-file("/var/www/build/packages/mist/src/mist.gleam", 468).
...
-file("/var/www/build/packages/mist/src/mist.gleam", 545).
...
-file("/var/www/build/packages/mist/src/mist.gleam", 533).
-spec start_https(
    builder(mist@internal@http:connection(), response_data()),
    binary(),
    binary()
...
-file("/var/www/build/packages/mist/src/mist.gleam", 599).
-spec internal_to_public_ws_message(
    mist@internal@websocket:handler_message(WIA)
) -> {ok, websocket_message(WIA)} | {error, nil}.
...
-file("/var/www/build/packages/mist/src/mist.gleam", 624).
-spec websocket(
    gleam@http@request:request(mist@internal@http:connection()),
    fun((WIG, mist@internal@websocket:websocket_connection(), websocket_message(WIH)) -> gleam@otp@actor:next(WIH, WIG)),
    fun((mist@internal@websocket:websocket_connection()) -> {WIG,
        gleam@option:option(gleam@erlang@process:selector(WIH))}),
    fun((WIG) -> nil)
...
-file("/var/www/build/packages/mist/src/mist.gleam", 677).
...
-file("/var/www/build/packages/mist/src/mist.gleam", 701).
...
-file("/var/www/build/packages/mist/src/mist.gleam", 739).
-spec event(gleam@string_builder:string_builder()) -> sse_event().
event(Data) ->
    {sse_event, none, none, Data}.

-file("/var/www/build/packages/mist/src/mist.gleam", 744).
-spec event_id(sse_event(), binary()) -> sse_event().
event_id(Event, Id) ->
    erlang:setelement(2, Event, {some, Id}).

-file("/var/www/build/packages/mist/src/mist.gleam", 749).
-spec event_name(sse_event(), binary()) -> sse_event().
event_name(Event, Name) ->
    erlang:setelement(3, Event, {some, Name}).

-file("/var/www/build/packages/mist/src/mist.gleam", 762).
-spec server_sent_events(
    gleam@http@request:request(mist@internal@http:connection()),
    gleam@http@response:response(any()),
    fun(() -> gleam@otp@actor:init_result(WIV, WIW)),
    fun((WIW, sse_connection(), WIV) -> gleam@otp@actor:next(WIW, WIV))
) -> gleam@http@response:response(response_data()).
...
-file("/var/www/build/packages/mist/src/mist.gleam", 807).
