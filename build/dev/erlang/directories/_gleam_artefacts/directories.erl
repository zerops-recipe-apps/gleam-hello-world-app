...
-file("/var/www/build/packages/directories/src/directories.gleam", 16).
...
-file("/var/www/build/packages/directories/src/directories.gleam", 11).
...
-file("/var/www/build/packages/directories/src/directories.gleam", 24).
-spec get_env(binary()) -> binary().
get_env(Var) ->
    gleam@result:unwrap(envoy_ffi:get(Var), <<""/utf8>>).

-file("/var/www/build/packages/directories/src/directories.gleam", 28).
-spec home_dir_path(binary()) -> binary().
home_dir_path(Path) ->
    <<(get_env(<<"HOME"/utf8>>))/binary, Path/binary>>.

-file("/var/www/build/packages/directories/src/directories.gleam", 32).
...
-file("/var/www/build/packages/directories/src/directories.gleam", 48).
...
-file("/var/www/build/packages/directories/src/directories.gleam", 74).
...
-file("/var/www/build/packages/directories/src/directories.gleam", 94).
...
-file("/var/www/build/packages/directories/src/directories.gleam", 115).
...
-file("/var/www/build/packages/directories/src/directories.gleam", 137).
...
-file("/var/www/build/packages/directories/src/directories.gleam", 151).
...
-file("/var/www/build/packages/directories/src/directories.gleam", 166).
...
-file("/var/www/build/packages/directories/src/directories.gleam", 178).
...
-file("/var/www/build/packages/directories/src/directories.gleam", 202).
...
-file("/var/www/build/packages/directories/src/directories.gleam", 214).
...
-file("/var/www/build/packages/directories/src/directories.gleam", 234).
...
-file("/var/www/build/packages/directories/src/directories.gleam", 247).
