...
-file("/var/www/build/packages/filepath/src/filepath.gleam", 48).
...
-file("/var/www/build/packages/filepath/src/filepath.gleam", 55).
...
-file("/var/www/build/packages/filepath/src/filepath.gleam", 35).
...
-file("/var/www/build/packages/filepath/src/filepath.gleam", 96).
...
-file("/var/www/build/packages/filepath/src/filepath.gleam", 138).
...
-file("/var/www/build/packages/filepath/src/filepath.gleam", 119).
...
-file("/var/www/build/packages/filepath/src/filepath.gleam", 76).
...
-file("/var/www/build/packages/filepath/src/filepath.gleam", 218).
...
-file("/var/www/build/packages/filepath/src/filepath.gleam", 168).
...
-file("/var/www/build/packages/filepath/src/filepath.gleam", 197).
...
-file("/var/www/build/packages/filepath/src/filepath.gleam", 245).
...
-file("/var/www/build/packages/filepath/src/filepath.gleam", 237).
...
-file("/var/www/build/packages/filepath/src/filepath.gleam", 272).
-spec is_absolute(binary()) -> boolean().
is_absolute(Path) ->
    gleam@string:starts_with(Path, <<"/"/utf8>>).

-file("/var/www/build/packages/filepath/src/filepath.gleam", 316).
...
-file("/var/www/build/packages/filepath/src/filepath.gleam", 341).
...
-file("/var/www/build/packages/filepath/src/filepath.gleam", 302).
