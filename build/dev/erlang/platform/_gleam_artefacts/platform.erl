...
-file("/var/www/build/packages/platform/src/platform.gleam", 54).
...
-file("/var/www/build/packages/platform/src/platform.gleam", 68).
-spec os() -> os().
os() ->
...
-file("/var/www/build/packages/platform/src/platform.gleam", 90).
-spec arch() -> arch().
arch() ->
