...
-file("/var/www/build/packages/simplifile/src/simplifile.gleam", 124).
...
-file("/var/www/build/packages/simplifile/src/simplifile.gleam", 221).
...
-file("/var/www/build/packages/simplifile/src/simplifile.gleam", 250).
...
-file("/var/www/build/packages/simplifile/src/simplifile.gleam", 270).
-spec file_info(binary()) -> {ok, file_info()} | {error, file_error()}.
file_info(Filepath) ->
    simplifile_erl:file_info(Filepath).

-file("/var/www/build/packages/simplifile/src/simplifile.gleam", 280).
-spec link_info(binary()) -> {ok, file_info()} | {error, file_error()}.
link_info(Filepath) ->
    simplifile_erl:link_info(Filepath).

-file("/var/www/build/packages/simplifile/src/simplifile.gleam", 324).
-spec delete(binary()) -> {ok, nil} | {error, file_error()}.
delete(Path) ->
    simplifile_erl:delete(Path).

-file("/var/www/build/packages/simplifile/src/simplifile.gleam", 331).
...
-file("/var/www/build/packages/simplifile/src/simplifile.gleam", 365).
-spec read_bits(binary()) -> {ok, bitstring()} | {error, file_error()}.
read_bits(Filepath) ->
    simplifile_erl:read_bits(Filepath).

-file("/var/www/build/packages/simplifile/src/simplifile.gleam", 288).
...
-file("/var/www/build/packages/simplifile/src/simplifile.gleam", 375).
-spec write_bits(binary(), bitstring()) -> {ok, nil} | {error, file_error()}.
write_bits(Filepath, Bits) ->
    simplifile_erl:write_bits(Filepath, Bits).

-file("/var/www/build/packages/simplifile/src/simplifile.gleam", 306).
...
-file("/var/www/build/packages/simplifile/src/simplifile.gleam", 388).
...
-file("/var/www/build/packages/simplifile/src/simplifile.gleam", 349).
...
-file("/var/www/build/packages/simplifile/src/simplifile.gleam", 483).
...
-file("/var/www/build/packages/simplifile/src/simplifile.gleam", 522).
-spec copy_file(binary(), binary()) -> {ok, nil} | {error, file_error()}.
copy_file(Src, Dest) ->
    _pipe = file:copy(Src, Dest),
    gleam@result:replace(_pipe, nil).

-file("/var/www/build/packages/simplifile/src/simplifile.gleam", 536).
-spec rename_file(binary(), binary()) -> {ok, nil} | {error, file_error()}.
rename_file(Src, Dest) ->
    simplifile_erl:rename_file(Src, Dest).

-file("/var/www/build/packages/simplifile/src/simplifile.gleam", 541).
-spec rename(binary(), binary()) -> {ok, nil} | {error, file_error()}.
rename(Src, Dest) ->
    simplifile_erl:rename_file(Src, Dest).

-file("/var/www/build/packages/simplifile/src/simplifile.gleam", 552).
...
-file("/var/www/build/packages/simplifile/src/simplifile.gleam", 544).
...
-file("/var/www/build/packages/simplifile/src/simplifile.gleam", 506).
...
-file("/var/www/build/packages/simplifile/src/simplifile.gleam", 588).
...
-file("/var/www/build/packages/simplifile/src/simplifile.gleam", 598).
...
-file("/var/www/build/packages/simplifile/src/simplifile.gleam", 608).
...
-file("/var/www/build/packages/simplifile/src/simplifile.gleam", 631).
...
-file("/var/www/build/packages/simplifile/src/simplifile.gleam", 639).
...
-file("/var/www/build/packages/simplifile/src/simplifile.gleam", 663).
...
-file("/var/www/build/packages/simplifile/src/simplifile.gleam", 678).
...
-file("/var/www/build/packages/simplifile/src/simplifile.gleam", 226).
...
-file("/var/www/build/packages/simplifile/src/simplifile.gleam", 714).
...
-file("/var/www/build/packages/simplifile/src/simplifile.gleam", 699).
...
-file("/var/www/build/packages/simplifile/src/simplifile.gleam", 722).
