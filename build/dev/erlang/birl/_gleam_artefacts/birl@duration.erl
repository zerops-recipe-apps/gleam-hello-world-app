...
-file("/var/www/build/packages/birl/src/birl/duration.gleam", 25).
...
-file("/var/www/build/packages/birl/src/birl/duration.gleam", 31).
...
-file("/var/www/build/packages/birl/src/birl/duration.gleam", 37).
-spec scale_up(duration(), integer()) -> duration().
scale_up(Value, Factor) ->
    {duration, Value@1} = Value,
    {duration, Value@1 * Factor}.

-file("/var/www/build/packages/birl/src/birl/duration.gleam", 42).
...
-file("/var/www/build/packages/birl/src/birl/duration.gleam", 47).
-spec micro_seconds(integer()) -> duration().
micro_seconds(Value) ->
    {duration, Value}.

-file("/var/www/build/packages/birl/src/birl/duration.gleam", 83).
...
-file("/var/www/build/packages/birl/src/birl/duration.gleam", 376).
...
-file("/var/www/build/packages/birl/src/birl/duration.gleam", 51).
-spec milli_seconds(integer()) -> duration().
milli_seconds(Value) ->
    {duration, Value * 1000}.

-file("/var/www/build/packages/birl/src/birl/duration.gleam", 55).
-spec seconds(integer()) -> duration().
seconds(Value) ->
    {duration, Value * 1000000}.

-file("/var/www/build/packages/birl/src/birl/duration.gleam", 59).
-spec minutes(integer()) -> duration().
minutes(Value) ->
    {duration, Value * 60000000}.

-file("/var/www/build/packages/birl/src/birl/duration.gleam", 63).
-spec hours(integer()) -> duration().
hours(Value) ->
    {duration, Value * 3600000000}.

-file("/var/www/build/packages/birl/src/birl/duration.gleam", 67).
-spec days(integer()) -> duration().
days(Value) ->
    {duration, Value * 86400000000}.

-file("/var/www/build/packages/birl/src/birl/duration.gleam", 71).
-spec weeks(integer()) -> duration().
weeks(Value) ->
    {duration, Value * 604800000000}.

-file("/var/www/build/packages/birl/src/birl/duration.gleam", 75).
-spec months(integer()) -> duration().
months(Value) ->
    {duration, Value * 2592000000000}.

-file("/var/www/build/packages/birl/src/birl/duration.gleam", 79).
-spec years(integer()) -> duration().
years(Value) ->
    {duration, Value * 31536000000000}.

-file("/var/www/build/packages/birl/src/birl/duration.gleam", 95).
...
-file("/var/www/build/packages/birl/src/birl/duration.gleam", 133).
...
-file("/var/www/build/packages/birl/src/birl/duration.gleam", 114).
...
-file("/var/www/build/packages/birl/src/birl/duration.gleam", 166).
...
-file("/var/www/build/packages/birl/src/birl/duration.gleam", 206).
...
-file("/var/www/build/packages/birl/src/birl/duration.gleam", 253).
...
-file("/var/www/build/packages/birl/src/birl/duration.gleam", 217).
...
-file("/var/www/build/packages/birl/src/birl/duration.gleam", 318).
