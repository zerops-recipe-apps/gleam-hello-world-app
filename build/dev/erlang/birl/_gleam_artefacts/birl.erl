...
-file("/var/www/build/packages/birl/src/birl.gleam", 504).
...
-file("/var/www/build/packages/birl/src/birl.gleam", 517).
...
-file("/var/www/build/packages/birl/src/birl.gleam", 838).
...
-file("/var/www/build/packages/birl/src/birl.gleam", 845).
-spec from_unix(integer()) -> time().
from_unix(Value) ->
    {time, Value * 1000000, 0, none, none}.

-file("/var/www/build/packages/birl/src/birl.gleam", 850).
...
-file("/var/www/build/packages/birl/src/birl.gleam", 857).
-spec from_unix_milli(integer()) -> time().
from_unix_milli(Value) ->
    {time, Value * 1000, 0, none, none}.

-file("/var/www/build/packages/birl/src/birl.gleam", 862).
...
-file("/var/www/build/packages/birl/src/birl.gleam", 869).
-spec from_unix_micro(integer()) -> time().
from_unix_micro(Value) ->
    {time, Value, 0, none, none}.

-file("/var/www/build/packages/birl/src/birl.gleam", 873).
...
-file("/var/www/build/packages/birl/src/birl.gleam", 889).
...
-file("/var/www/build/packages/birl/src/birl.gleam", 986).
...
-file("/var/www/build/packages/birl/src/birl.gleam", 1008).
...
-file("/var/www/build/packages/birl/src/birl.gleam", 1049).
...
-file("/var/www/build/packages/birl/src/birl.gleam", 1061).
...
-file("/var/www/build/packages/birl/src/birl.gleam", 1140).
...
-file("/var/www/build/packages/birl/src/birl.gleam", 1167).
...
-file("/var/www/build/packages/birl/src/birl.gleam", 1181).
-spec get_timezone(time()) -> gleam@option:option(binary()).
get_timezone(Value) ->
    {time, _, _, Timezone, _} = Value,
    Timezone.

-file("/var/www/build/packages/birl/src/birl.gleam", 1324).
...
-file("/var/www/build/packages/birl/src/birl.gleam", 1191).
...
-file("/var/www/build/packages/birl/src/birl.gleam", 1375).
...
-file("/var/www/build/packages/birl/src/birl.gleam", 1200).
...
-file("/var/www/build/packages/birl/src/birl.gleam", 1491).
...
-file("/var/www/build/packages/birl/src/birl.gleam", 1504).
...
-file("/var/www/build/packages/birl/src/birl.gleam", 1516).
...
-file("/var/www/build/packages/birl/src/birl.gleam", 1436).
...
-file("/var/www/build/packages/birl/src/birl.gleam", 1480).
...
-file("/var/www/build/packages/birl/src/birl.gleam", 397).
...
-file("/var/www/build/packages/birl/src/birl.gleam", 459).
...
-file("/var/www/build/packages/birl/src/birl.gleam", 1547).
...
-file("/var/www/build/packages/birl/src/birl.gleam", 1574).
...
-file("/var/www/build/packages/birl/src/birl.gleam", 84).
-spec utc_now() -> time().
utc_now() ->
    Now = birl_ffi:now(),
...
-file("/var/www/build/packages/birl/src/birl.gleam", 95).
...
-file("/var/www/build/packages/birl/src/birl.gleam", 103).
...
-file("/var/www/build/packages/birl/src/birl.gleam", 121).
-spec monotonic_now() -> integer().
monotonic_now() ->
    birl_ffi:monotonic_now().

-file("/var/www/build/packages/birl/src/birl.gleam", 1314).
...
-file("/var/www/build/packages/birl/src/birl.gleam", 126).
...
-file("/var/www/build/packages/birl/src/birl.gleam", 146).
...
-file("/var/www/build/packages/birl/src/birl.gleam", 165).
...
-file("/var/www/build/packages/birl/src/birl.gleam", 195).
...
-file("/var/www/build/packages/birl/src/birl.gleam", 223).
...
-file("/var/www/build/packages/birl/src/birl.gleam", 525).
...
-file("/var/www/build/packages/birl/src/birl.gleam", 1097).
...
-file("/var/www/build/packages/birl/src/birl.gleam", 1103).
...
-file("/var/www/build/packages/birl/src/birl.gleam", 1120).
...
-file("/var/www/build/packages/birl/src/birl.gleam", 1219).
-spec get_day(time()) -> day().
get_day(Value) ->
    {{Year, Month, Day}, _, _} = to_parts(Value),
    {day, Year, Month, Day}.

-file("/var/www/build/packages/birl/src/birl.gleam", 1238).
-spec get_time_of_day(time()) -> time_of_day().
get_time_of_day(Value) ->
    {_, {Hour, Minute, Second, Milli_second}, _} = to_parts(Value),
    {time_of_day, Hour, Minute, Second, Milli_second}.

-file("/var/www/build/packages/birl/src/birl.gleam", 1245).
...
-file("/var/www/build/packages/birl/src/birl.gleam", 1252).
...
-file("/var/www/build/packages/birl/src/birl.gleam", 1303).
-spec from_parts(
    {integer(), integer(), integer()},
    {integer(), integer(), integer(), integer()},
    binary()
...
-file("/var/www/build/packages/birl/src/birl.gleam", 294).
...
-file("/var/www/build/packages/birl/src/birl.gleam", 569).
...
-file("/var/www/build/packages/birl/src/birl.gleam", 1206).
...
-file("/var/www/build/packages/birl/src/birl.gleam", 1224).
...
-file("/var/www/build/packages/birl/src/birl.gleam", 1030).
...
-file("/var/www/build/packages/birl/src/birl.gleam", 668).
...
-file("/var/www/build/packages/birl/src/birl.gleam", 63).
-spec now() -> time().
now() ->
    Now = birl_ffi:now(),
...
-file("/var/www/build/packages/birl/src/birl.gleam", 1262).
...
-file("/var/www/build/packages/birl/src/birl.gleam", 1291).
...
-file("/var/www/build/packages/birl/src/birl.gleam", 912).
...
-file("/var/www/build/packages/birl/src/birl.gleam", 955).
...
-file("/var/www/build/packages/birl/src/birl.gleam", 1073).
...
-file("/var/www/build/packages/birl/src/birl.gleam", 724).
...
-file("/var/www/build/packages/birl/src/birl.gleam", 1085).
