...
-file("/var/www/build/packages/gramps/src/gramps/websocket.gleam", 30).
...
-file("/var/www/build/packages/gramps/src/gramps/websocket.gleam", 204).
...
-file("/var/www/build/packages/gramps/src/gramps/websocket.gleam", 212).
...
-file("/var/www/build/packages/gramps/src/gramps/websocket.gleam", 242).
-spec make_frame(
    integer(),
    integer(),
    bitstring(),
...
-file("/var/www/build/packages/gramps/src/gramps/websocket.gleam", 165).
...
-file("/var/www/build/packages/gramps/src/gramps/websocket.gleam", 184).
...
-file("/var/www/build/packages/gramps/src/gramps/websocket.gleam", 269).
...
-file("/var/www/build/packages/gramps/src/gramps/websocket.gleam", 279).
-spec to_text_frame(
    binary(),
...
-file("/var/www/build/packages/gramps/src/gramps/websocket.gleam", 297).
...
-file("/var/www/build/packages/gramps/src/gramps/websocket.gleam", 327).
...
-file("/var/www/build/packages/gramps/src/gramps/websocket.gleam", 343).
...
-file("/var/www/build/packages/gramps/src/gramps/websocket.gleam", 389).
-spec inflate(
    boolean(),
    gleam@option:option(gramps@websocket@compression:context()),
    bitstring()
...
-file("/var/www/build/packages/gramps/src/gramps/websocket.gleam", 63).
...
-file("/var/www/build/packages/gramps/src/gramps/websocket.gleam", 314).
-spec get_messages(
    bitstring(),
    list(parsed_frame()),
    gleam@option:option(gramps@websocket@compression:context())
...
-file("/var/www/build/packages/gramps/src/gramps/websocket.gleam", 405).
...
-file("/var/www/build/packages/gramps/src/gramps/websocket.gleam", 376).
