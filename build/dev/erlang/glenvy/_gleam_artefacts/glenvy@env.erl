...
-file("/var/www/build/packages/glenvy/src/glenvy/env.gleam", 19).
-spec get_all() -> gleam@dict:dict(binary(), binary()).
get_all() ->
    glenvy@internal@os:get_all_env().

-file("/var/www/build/packages/glenvy/src/glenvy/env.gleam", 24).
...
-file("/var/www/build/packages/glenvy/src/glenvy/env.gleam", 34).
-spec get(binary(), fun((binary()) -> {ok, QDE} | {error, nil})) -> {ok, QDE} |
    {error, error()}.
get(Name, Parse) ->
...
-file("/var/www/build/packages/glenvy/src/glenvy/env.gleam", 48).
-spec get_int(binary()) -> {ok, integer()} | {error, error()}.
get_int(Name) ->
    _pipe = Name,
    get(_pipe, fun gleam@int:parse/1).

-file("/var/www/build/packages/glenvy/src/glenvy/env.gleam", 56).
-spec get_float(binary()) -> {ok, float()} | {error, error()}.
get_float(Name) ->
    _pipe = Name,
    get(_pipe, fun gleam@float:parse/1).

-file("/var/www/build/packages/glenvy/src/glenvy/env.gleam", 82).
