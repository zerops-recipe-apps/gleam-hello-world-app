...
-file("/var/www/build/packages/glenvy/src/glenvy/internal/parser.gleam", 83).
...
-file("/var/www/build/packages/glenvy/src/glenvy/internal/parser.gleam", 62).
...
-file("/var/www/build/packages/glenvy/src/glenvy/internal/parser.gleam", 100).
...
-file("/var/www/build/packages/glenvy/src/glenvy/internal/parser.gleam", 43).
...
-file("/var/www/build/packages/glenvy/src/glenvy/internal/parser.gleam", 29).
...
-file("/var/www/build/packages/glenvy/src/glenvy/internal/parser.gleam", 18).
...
-file("/var/www/build/packages/glenvy/src/glenvy/internal/parser.gleam", 12).
