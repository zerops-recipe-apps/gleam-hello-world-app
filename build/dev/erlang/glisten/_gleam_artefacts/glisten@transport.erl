...
-file("/var/www/build/packages/glisten/src/glisten/transport.gleam", 17).
...
-file("/var/www/build/packages/glisten/src/glisten/transport.gleam", 28).
...
-file("/var/www/build/packages/glisten/src/glisten/transport.gleam", 39).
...
-file("/var/www/build/packages/glisten/src/glisten/transport.gleam", 50).
...
-file("/var/www/build/packages/glisten/src/glisten/transport.gleam", 60).
...
-file("/var/www/build/packages/glisten/src/glisten/transport.gleam", 67).
...
-file("/var/www/build/packages/glisten/src/glisten/transport.gleam", 79).
...
-file("/var/www/build/packages/glisten/src/glisten/transport.gleam", 90).
-spec send(
    transport(),
    glisten@socket:socket(),
...
-file("/var/www/build/packages/glisten/src/glisten/transport.gleam", 101).
...
-file("/var/www/build/packages/glisten/src/glisten/transport.gleam", 108).
...
-file("/var/www/build/packages/glisten/src/glisten/transport.gleam", 118).
-spec set_opts(
    transport(),
    glisten@socket:socket(),
...
-file("/var/www/build/packages/glisten/src/glisten/transport.gleam", 129).
...
-file("/var/www/build/packages/glisten/src/glisten/transport.gleam", 139).
...
-file("/var/www/build/packages/glisten/src/glisten/transport.gleam", 149).
...
-file("/var/www/build/packages/glisten/src/glisten/transport.gleam", 173).
...
-file("/var/www/build/packages/glisten/src/glisten/transport.gleam", 177).
...
-file("/var/www/build/packages/glisten/src/glisten/transport.gleam", 197).
-spec socket_info(glisten@socket:socket()) -> gleam@dict:dict(gleam@erlang@atom:atom_(), gleam@dynamic:dynamic_()).
socket_info(Socket) ->
    socket:info(Socket).

-file("/var/www/build/packages/glisten/src/glisten/transport.gleam", 199).
...
-file("/var/www/build/packages/glisten/src/glisten/transport.gleam", 210).
...
-file("/var/www/build/packages/glisten/src/glisten/transport.gleam", 223).
