...
-file("/var/www/build/packages/gleam_stdlib/src/gleam/function.gleam", 2).
-spec compose(fun((DPQ) -> DPR), fun((DPR) -> DPS)) -> fun((DPQ) -> DPS).
compose(Fun1, Fun2) ->
    fun(A) -> Fun2(Fun1(A)) end.

-file("/var/www/build/packages/gleam_stdlib/src/gleam/function.gleam", 7).
-spec curry2(fun((DPT, DPU) -> DPV)) -> fun((DPT) -> fun((DPU) -> DPV)).
curry2(Fun) ->
    fun(A) -> fun(B) -> Fun(A, B) end end.

-file("/var/www/build/packages/gleam_stdlib/src/gleam/function.gleam", 12).
-spec curry3(fun((DPX, DPY, DPZ) -> DQA)) -> fun((DPX) -> fun((DPY) -> fun((DPZ) -> DQA))).
curry3(Fun) ->
    fun(A) -> fun(B) -> fun(C) -> Fun(A, B, C) end end end.

-file("/var/www/build/packages/gleam_stdlib/src/gleam/function.gleam", 17).
...
-file("/var/www/build/packages/gleam_stdlib/src/gleam/function.gleam", 22).
...
-file("/var/www/build/packages/gleam_stdlib/src/gleam/function.gleam", 27).
...
-file("/var/www/build/packages/gleam_stdlib/src/gleam/function.gleam", 36).
-spec flip(fun((DQX, DQY) -> DQZ)) -> fun((DQY, DQX) -> DQZ).
flip(Fun) ->
    fun(B, A) -> Fun(A, B) end.

-file("/var/www/build/packages/gleam_stdlib/src/gleam/function.gleam", 42).
-spec identity(DRA) -> DRA.
identity(X) ->
    X.

-file("/var/www/build/packages/gleam_stdlib/src/gleam/function.gleam", 47).
-spec constant(DRB) -> fun((any()) -> DRB).
constant(Value) ->
    fun(_) -> Value end.

-file("/var/www/build/packages/gleam_stdlib/src/gleam/function.gleam", 56).
-spec tap(DRD, fun((DRD) -> any())) -> DRD.
tap(Arg, Effect) ->
    Effect(Arg),
    Arg.

-file("/var/www/build/packages/gleam_stdlib/src/gleam/function.gleam", 62).
-spec apply1(fun((DRF) -> DRG), DRF) -> DRG.
apply1(Fun, Arg1) ->
    Fun(Arg1).

-file("/var/www/build/packages/gleam_stdlib/src/gleam/function.gleam", 67).
-spec apply2(fun((DRH, DRI) -> DRJ), DRH, DRI) -> DRJ.
apply2(Fun, Arg1, Arg2) ->
    Fun(Arg1, Arg2).

-file("/var/www/build/packages/gleam_stdlib/src/gleam/function.gleam", 72).
