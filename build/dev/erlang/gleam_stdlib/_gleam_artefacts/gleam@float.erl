...
-file("/var/www/build/packages/gleam_stdlib/src/gleam/float.gleam", 32).
-spec parse(binary()) -> {ok, float()} | {error, nil}.
parse(String) ->
    gleam_stdlib:parse_float(String).

-file("/var/www/build/packages/gleam_stdlib/src/gleam/float.gleam", 49).
-spec to_string(float()) -> binary().
to_string(X) ->
    gleam_stdlib:float_to_string(X).

-file("/var/www/build/packages/gleam_stdlib/src/gleam/float.gleam", 86).
...
-file("/var/www/build/packages/gleam_stdlib/src/gleam/float.gleam", 167).
...
-file("/var/www/build/packages/gleam_stdlib/src/gleam/float.gleam", 183).
...
-file("/var/www/build/packages/gleam_stdlib/src/gleam/float.gleam", 66).
...
-file("/var/www/build/packages/gleam_stdlib/src/gleam/float.gleam", 199).
-spec ceiling(float()) -> float().
ceiling(X) ->
    math:ceil(X).

-file("/var/www/build/packages/gleam_stdlib/src/gleam/float.gleam", 216).
-spec floor(float()) -> float().
floor(X) ->
    math:floor(X).

-file("/var/www/build/packages/gleam_stdlib/src/gleam/float.gleam", 262).
-spec truncate(float()) -> integer().
truncate(X) ->
    erlang:trunc(X).

-file("/var/www/build/packages/gleam_stdlib/src/gleam/float.gleam", 310).
...
-file("/var/www/build/packages/gleam_stdlib/src/gleam/float.gleam", 116).
...
-file("/var/www/build/packages/gleam_stdlib/src/gleam/float.gleam", 149).
-spec loosely_equals(float(), float(), float()) -> boolean().
loosely_equals(A, B, Tolerance) ->
    Difference = absolute_value(A - B),
    Difference =< Tolerance.

-file("/var/www/build/packages/gleam_stdlib/src/gleam/float.gleam", 347).
...
-file("/var/www/build/packages/gleam_stdlib/src/gleam/float.gleam", 379).
-spec square_root(float()) -> {ok, float()} | {error, nil}.
square_root(X) ->
    power(X, 0.5).

-file("/var/www/build/packages/gleam_stdlib/src/gleam/float.gleam", 392).
-spec negate(float()) -> float().
negate(X) ->
    -1.0 * X.

-file("/var/www/build/packages/gleam_stdlib/src/gleam/float.gleam", 238).
-spec round(float()) -> integer().
round(X) ->
    erlang:round(X).

-file("/var/www/build/packages/gleam_stdlib/src/gleam/float.gleam", 287).
...
-file("/var/www/build/packages/gleam_stdlib/src/gleam/float.gleam", 410).
...
-file("/var/www/build/packages/gleam_stdlib/src/gleam/float.gleam", 405).
-spec sum(list(float())) -> float().
sum(Numbers) ->
    _pipe = Numbers,
    do_sum(_pipe, +0.0).

-file("/var/www/build/packages/gleam_stdlib/src/gleam/float.gleam", 433).
...
-file("/var/www/build/packages/gleam_stdlib/src/gleam/float.gleam", 426).
...
-file("/var/www/build/packages/gleam_stdlib/src/gleam/float.gleam", 455).
-spec random() -> float().
random() ->
    rand:uniform().

-file("/var/www/build/packages/gleam_stdlib/src/gleam/float.gleam", 484).
...
-file("/var/www/build/packages/gleam_stdlib/src/gleam/float.gleam", 505).
...
-file("/var/www/build/packages/gleam_stdlib/src/gleam/float.gleam", 536).
-spec add(float(), float()) -> float().
add(A, B) ->
    A + B.

-file("/var/www/build/packages/gleam_stdlib/src/gleam/float.gleam", 564).
-spec multiply(float(), float()) -> float().
multiply(A, B) ->
    A * B.

-file("/var/www/build/packages/gleam_stdlib/src/gleam/float.gleam", 597).
