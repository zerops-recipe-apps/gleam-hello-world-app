...
-file("/var/www/build/packages/gleam_stdlib/src/gleam/io.gleam", 15).
-spec print(binary()) -> nil.
print(String) ->
    gleam_stdlib:print(String).

-file("/var/www/build/packages/gleam_stdlib/src/gleam/io.gleam", 35).
-spec print_error(binary()) -> nil.
print_error(String) ->
    gleam_stdlib:print_error(String).

-file("/var/www/build/packages/gleam_stdlib/src/gleam/io.gleam", 53).
-spec println(binary()) -> nil.
println(String) ->
    gleam_stdlib:println(String).

-file("/var/www/build/packages/gleam_stdlib/src/gleam/io.gleam", 71).
-spec println_error(binary()) -> nil.
println_error(String) ->
    gleam_stdlib:println_error(String).

-file("/var/www/build/packages/gleam_stdlib/src/gleam/io.gleam", 108).
-spec debug(DSN) -> DSN.
debug(Term) ->
    _pipe = Term,
