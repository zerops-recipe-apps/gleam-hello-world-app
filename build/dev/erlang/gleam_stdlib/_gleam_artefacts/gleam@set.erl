...
-file("/var/www/build/packages/gleam_stdlib/src/gleam/set.gleam", 32).
-spec new() -> set(any()).
new() ->
    {set, gleam@dict:new()}.

-file("/var/www/build/packages/gleam_stdlib/src/gleam/set.gleam", 50).
-spec size(set(any())) -> integer().
size(Set) ->
    maps:size(erlang:element(2, Set)).

-file("/var/www/build/packages/gleam_stdlib/src/gleam/set.gleam", 68).
-spec is_empty(set(any())) -> boolean().
is_empty(Set) ->
    Set =:= new().

-file("/var/www/build/packages/gleam_stdlib/src/gleam/set.gleam", 110).
...
-file("/var/www/build/packages/gleam_stdlib/src/gleam/set.gleam", 131).
-spec delete(set(FDD), FDD) -> set(FDD).
delete(Set, Member) ->
    {set, gleam@dict:delete(erlang:element(2, Set), Member)}.

-file("/var/www/build/packages/gleam_stdlib/src/gleam/set.gleam", 149).
-spec to_list(set(FDG)) -> list(FDG).
to_list(Set) ->
    gleam@dict:keys(erlang:element(2, Set)).

-file("/var/www/build/packages/gleam_stdlib/src/gleam/set.gleam", 190).
...
-file("/var/www/build/packages/gleam_stdlib/src/gleam/set.gleam", 305).
-spec intersection(set(FEN), set(FEN)) -> set(FEN).
intersection(First, Second) ->
    {Larger, Smaller} = order(First, Second),
    take(Larger, to_list(Smaller)).

-file("/var/www/build/packages/gleam_stdlib/src/gleam/set.gleam", 323).
-spec difference(set(FER), set(FER)) -> set(FER).
difference(First, Second) ->
    drop(First, to_list(Second)).

-file("/var/www/build/packages/gleam_stdlib/src/gleam/set.gleam", 344).
-spec is_subset(set(FEV), set(FEV)) -> boolean().
is_subset(First, Second) ->
    intersection(First, Second) =:= First.

-file("/var/www/build/packages/gleam_stdlib/src/gleam/set.gleam", 362).
-spec is_disjoint(set(FEY), set(FEY)) -> boolean().
is_disjoint(First, Second) ->
    intersection(First, Second) =:= new().

-file("/var/www/build/packages/gleam_stdlib/src/gleam/set.gleam", 402).
...
-file("/var/www/build/packages/gleam_stdlib/src/gleam/set.gleam", 86).
-spec insert(set(FCY), FCY) -> set(FCY).
insert(Set, Member) ->
    {set, gleam@dict:insert(erlang:element(2, Set), Member, [])}.

-file("/var/www/build/packages/gleam_stdlib/src/gleam/set.gleam", 167).
...
-file("/var/www/build/packages/gleam_stdlib/src/gleam/set.gleam", 232).
-spec map(set(FDS), fun((FDS) -> FDU)) -> set(FDU).
map(Set, Fun) ->
    fold(Set, new(), fun(Acc, Member) -> insert(Acc, Fun(Member)) end).

-file("/var/www/build/packages/gleam_stdlib/src/gleam/set.gleam", 289).
-spec union(set(FEJ), set(FEJ)) -> set(FEJ).
union(First, Second) ->
    {Larger, Smaller} = order(First, Second),
    fold(Smaller, Larger, fun insert/2).

-file("/var/www/build/packages/gleam_stdlib/src/gleam/set.gleam", 374).
