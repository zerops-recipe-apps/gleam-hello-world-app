...
-file("/var/www/build/packages/gleam_stdlib/src/gleam/list.gleam", 61).
...
-file("/var/www/build/packages/gleam_stdlib/src/gleam/list.gleam", 57).
-spec length(list(any())) -> integer().
length(List) ->
    erlang:length(List).

-file("/var/www/build/packages/gleam_stdlib/src/gleam/list.gleam", 130).
...
-file("/var/www/build/packages/gleam_stdlib/src/gleam/list.gleam", 126).
-spec reverse(list(AAV)) -> list(AAV).
reverse(List) ->
    lists:reverse(List).

-file("/var/www/build/packages/gleam_stdlib/src/gleam/list.gleam", 158).
-spec is_empty(list(any())) -> boolean().
is_empty(List) ->
    List =:= [].

-file("/var/www/build/packages/gleam_stdlib/src/gleam/list.gleam", 194).
...
-file("/var/www/build/packages/gleam_stdlib/src/gleam/list.gleam", 221).
...
-file("/var/www/build/packages/gleam_stdlib/src/gleam/list.gleam", 250).
...
-file("/var/www/build/packages/gleam_stdlib/src/gleam/list.gleam", 257).
...
-file("/var/www/build/packages/gleam_stdlib/src/gleam/list.gleam", 302).
...
-file("/var/www/build/packages/gleam_stdlib/src/gleam/list.gleam", 330).
-spec filter(list(ACH), fun((ACH) -> boolean())) -> list(ACH).
filter(List, Predicate) ->
    do_filter(List, Predicate, []).

-file("/var/www/build/packages/gleam_stdlib/src/gleam/list.gleam", 334).
-spec do_filter_map(
    list(ACK),
...
-file("/var/www/build/packages/gleam_stdlib/src/gleam/list.gleam", 366).
-spec filter_map(list(ACS), fun((ACS) -> {ok, ACU} | {error, any()})) -> list(ACU).
filter_map(List, Fun) ->
    do_filter_map(List, Fun, []).

-file("/var/www/build/packages/gleam_stdlib/src/gleam/list.gleam", 370).
...
-file("/var/www/build/packages/gleam_stdlib/src/gleam/list.gleam", 387).
-spec map(list(ADE), fun((ADE) -> ADG)) -> list(ADG).
map(List, Fun) ->
    do_map(List, Fun, []).

-file("/var/www/build/packages/gleam_stdlib/src/gleam/list.gleam", 411).
...
-file("/var/www/build/packages/gleam_stdlib/src/gleam/list.gleam", 407).
-spec map2(list(ADI), list(ADK), fun((ADI, ADK) -> ADM)) -> list(ADM).
map2(List1, List2, Fun) ->
    do_map2(List1, List2, Fun, []).

-file("/var/www/build/packages/gleam_stdlib/src/gleam/list.gleam", 449).
-spec do_index_map(
    list(AEA),
    fun((AEA, integer()) -> AEC),
    integer(),
...
-file("/var/www/build/packages/gleam_stdlib/src/gleam/list.gleam", 477).
-spec index_map(list(AEF), fun((AEF, integer()) -> AEH)) -> list(AEH).
index_map(List, Fun) ->
    do_index_map(List, Fun, 0, []).

-file("/var/www/build/packages/gleam_stdlib/src/gleam/list.gleam", 481).
...
-file("/var/www/build/packages/gleam_stdlib/src/gleam/list.gleam", 528).
...
-file("/var/www/build/packages/gleam_stdlib/src/gleam/list.gleam", 555).
...
-file("/var/www/build/packages/gleam_stdlib/src/gleam/list.gleam", 566).
...
-file("/var/www/build/packages/gleam_stdlib/src/gleam/list.gleam", 597).
-spec take(list(AFJ), integer()) -> list(AFJ).
take(List, N) ->
    do_take(List, N, []).

-file("/var/www/build/packages/gleam_stdlib/src/gleam/list.gleam", 610).
-spec new() -> list(any()).
new() ->
    [].

-file("/var/www/build/packages/gleam_stdlib/src/gleam/list.gleam", 630).
-spec wrap(AFO) -> list(AFO).
wrap(Item) ->
    [Item].

-file("/var/www/build/packages/gleam_stdlib/src/gleam/list.gleam", 651).
...
-file("/var/www/build/packages/gleam_stdlib/src/gleam/list.gleam", 647).
-spec append(list(AFQ), list(AFQ)) -> list(AFQ).
append(First, Second) ->
    lists:append(First, Second).

-file("/var/www/build/packages/gleam_stdlib/src/gleam/list.gleam", 671).
-spec prepend(list(AFY), AFY) -> list(AFY).
prepend(List, Item) ->
    [Item | List].

-file("/var/www/build/packages/gleam_stdlib/src/gleam/list.gleam", 676).
...
-file("/var/www/build/packages/gleam_stdlib/src/gleam/list.gleam", 683).
...
-file("/var/www/build/packages/gleam_stdlib/src/gleam/list.gleam", 703).
-spec concat(list(list(AGK))) -> list(AGK).
concat(Lists) ->
    do_concat(Lists, []).

-file("/var/www/build/packages/gleam_stdlib/src/gleam/list.gleam", 719).
-spec flatten(list(list(AGO))) -> list(AGO).
flatten(Lists) ->
    do_concat(Lists, []).

-file("/var/www/build/packages/gleam_stdlib/src/gleam/list.gleam", 732).
-spec flat_map(list(AGS), fun((AGS) -> list(AGU))) -> list(AGU).
flat_map(List, Fun) ->
    _pipe = map(List, Fun),
    flatten(_pipe).

-file("/var/www/build/packages/gleam_stdlib/src/gleam/list.gleam", 745).
...
-file("/var/www/build/packages/gleam_stdlib/src/gleam/list.gleam", 90).
...
-file("/var/www/build/packages/gleam_stdlib/src/gleam/list.gleam", 298).
-spec group(list(ABX), fun((ABX) -> ABZ)) -> gleam@dict:dict(ABZ, list(ABX)).
group(List, Key) ->
    fold(List, gleam@dict:new(), update_group(Key)).

-file("/var/www/build/packages/gleam_stdlib/src/gleam/list.gleam", 436).
...
-file("/var/www/build/packages/gleam_stdlib/src/gleam/list.gleam", 767).
...
-file("/var/www/build/packages/gleam_stdlib/src/gleam/list.gleam", 778).
-spec do_index_fold(
    list(AHD),
    AHF,
...
-file("/var/www/build/packages/gleam_stdlib/src/gleam/list.gleam", 800).
-spec index_fold(list(AHG), AHI, fun((AHI, AHG, integer()) -> AHI)) -> AHI.
index_fold(List, Initial, Fun) ->
    do_index_fold(List, Initial, Fun, 0).

-file("/var/www/build/packages/gleam_stdlib/src/gleam/list.gleam", 827).
...
-file("/var/www/build/packages/gleam_stdlib/src/gleam/list.gleam", 866).
...
-file("/var/www/build/packages/gleam_stdlib/src/gleam/list.gleam", 903).
...
-file("/var/www/build/packages/gleam_stdlib/src/gleam/list.gleam", 939).
...
-file("/var/www/build/packages/gleam_stdlib/src/gleam/list.gleam", 974).
...
-file("/var/www/build/packages/gleam_stdlib/src/gleam/list.gleam", 1011).
...
-file("/var/www/build/packages/gleam_stdlib/src/gleam/list.gleam", 1022).
...
-file("/var/www/build/packages/gleam_stdlib/src/gleam/list.gleam", 1057).
-spec zip(list(AIR), list(AIT)) -> list({AIR, AIT}).
zip(List, Other) ->
    do_zip(List, Other, []).

-file("/var/www/build/packages/gleam_stdlib/src/gleam/list.gleam", 1087).
...
-file("/var/www/build/packages/gleam_stdlib/src/gleam/list.gleam", 1097).
...
-file("/var/www/build/packages/gleam_stdlib/src/gleam/list.gleam", 1123).
-spec unzip(list({AJK, AJL})) -> {list(AJK), list(AJL)}.
unzip(Input) ->
    do_unzip(Input, [], []).

-file("/var/www/build/packages/gleam_stdlib/src/gleam/list.gleam", 1127).
...
-file("/var/www/build/packages/gleam_stdlib/src/gleam/list.gleam", 1150).
...
-file("/var/www/build/packages/gleam_stdlib/src/gleam/list.gleam", 1168).
...
-file("/var/www/build/packages/gleam_stdlib/src/gleam/list.gleam", 1249).
-spec sequences(
    list(AKC),
...
-file("/var/www/build/packages/gleam_stdlib/src/gleam/list.gleam", 1397).
...
-file("/var/www/build/packages/gleam_stdlib/src/gleam/list.gleam", 1350).
...
-file("/var/www/build/packages/gleam_stdlib/src/gleam/list.gleam", 1424).
...
-file("/var/www/build/packages/gleam_stdlib/src/gleam/list.gleam", 1372).
...
-file("/var/www/build/packages/gleam_stdlib/src/gleam/list.gleam", 1316).
-spec merge_all(
    list(list(AKJ)),
    sorting(),
...
-file("/var/www/build/packages/gleam_stdlib/src/gleam/list.gleam", 1187).
...
-file("/var/www/build/packages/gleam_stdlib/src/gleam/list.gleam", 1464).
...
-file("/var/www/build/packages/gleam_stdlib/src/gleam/list.gleam", 1460).
-spec range(integer(), integer()) -> list(integer()).
range(Start, Stop) ->
    tail_recursive_range(Start, Stop, []).

-file("/var/www/build/packages/gleam_stdlib/src/gleam/list.gleam", 1472).
...
-file("/var/www/build/packages/gleam_stdlib/src/gleam/list.gleam", 1493).
-spec repeat(ALP, integer()) -> list(ALP).
repeat(A, Times) ->
    do_repeat(A, Times, []).

-file("/var/www/build/packages/gleam_stdlib/src/gleam/list.gleam", 1497).
...
-file("/var/www/build/packages/gleam_stdlib/src/gleam/list.gleam", 1530).
-spec split(list(ALW), integer()) -> {list(ALW), list(ALW)}.
split(List, Index) ->
    do_split(List, Index, []).

-file("/var/www/build/packages/gleam_stdlib/src/gleam/list.gleam", 1534).
...
-file("/var/www/build/packages/gleam_stdlib/src/gleam/list.gleam", 1567).
-spec split_while(list(AMF), fun((AMF) -> boolean())) -> {list(AMF), list(AMF)}.
split_while(List, Predicate) ->
    do_split_while(List, Predicate, []).

-file("/var/www/build/packages/gleam_stdlib/src/gleam/list.gleam", 1599).
...
-file("/var/www/build/packages/gleam_stdlib/src/gleam/list.gleam", 1630).
...
-file("/var/www/build/packages/gleam_stdlib/src/gleam/list.gleam", 1643).
...
-file("/var/www/build/packages/gleam_stdlib/src/gleam/list.gleam", 1675).
-spec pop(list(AMW), fun((AMW) -> boolean())) -> {ok, {AMW, list(AMW)}} |
    {error, nil}.
pop(List, Is_desired) ->
    do_pop(List, Is_desired, []).

-file("/var/www/build/packages/gleam_stdlib/src/gleam/list.gleam", 1682).
...
-file("/var/www/build/packages/gleam_stdlib/src/gleam/list.gleam", 1719).
...
-file("/var/www/build/packages/gleam_stdlib/src/gleam/list.gleam", 1749).
...
-file("/var/www/build/packages/gleam_stdlib/src/gleam/list.gleam", 1776).
...
-file("/var/www/build/packages/gleam_stdlib/src/gleam/list.gleam", 1798).
...
-file("/var/www/build/packages/gleam_stdlib/src/gleam/list.gleam", 1824).
...
-file("/var/www/build/packages/gleam_stdlib/src/gleam/list.gleam", 1838).
...
-file("/var/www/build/packages/gleam_stdlib/src/gleam/list.gleam", 1861).
-spec partition(list(AOU), fun((AOU) -> boolean())) -> {list(AOU), list(AOU)}.
partition(List, Categorise) ->
    do_partition(List, Categorise, [], []).

-file("/var/www/build/packages/gleam_stdlib/src/gleam/list.gleam", 1877).
...
-file("/var/www/build/packages/gleam_stdlib/src/gleam/list.gleam", 1896).
...
-file("/var/www/build/packages/gleam_stdlib/src/gleam/list.gleam", 1919).
...
-file("/var/www/build/packages/gleam_stdlib/src/gleam/list.gleam", 1940).
-spec window_by_2(list(APM)) -> list({APM, APM}).
window_by_2(List) ->
    zip(List, drop(List, 1)).

-file("/var/www/build/packages/gleam_stdlib/src/gleam/list.gleam", 1953).
...
-file("/var/www/build/packages/gleam_stdlib/src/gleam/list.gleam", 1967).
...
-file("/var/www/build/packages/gleam_stdlib/src/gleam/list.gleam", 1991).
-spec take_while(list(APW), fun((APW) -> boolean())) -> list(APW).
take_while(List, Predicate) ->
    do_take_while(List, Predicate, []).

-file("/var/www/build/packages/gleam_stdlib/src/gleam/list.gleam", 1998).
...
-file("/var/www/build/packages/gleam_stdlib/src/gleam/list.gleam", 2030).
...
-file("/var/www/build/packages/gleam_stdlib/src/gleam/list.gleam", 2037).
-spec do_sized_chunk(
    list(AQM),
    integer(),
    integer(),
...
-file("/var/www/build/packages/gleam_stdlib/src/gleam/list.gleam", 2079).
-spec sized_chunk(list(AQT), integer()) -> list(list(AQT)).
sized_chunk(List, Count) ->
    do_sized_chunk(List, Count, Count, [], []).

-file("/var/www/build/packages/gleam_stdlib/src/gleam/list.gleam", 2103).
...
-file("/var/www/build/packages/gleam_stdlib/src/gleam/list.gleam", 2110).
...
-file("/var/www/build/packages/gleam_stdlib/src/gleam/list.gleam", 2134).
-spec scan(list(ARG), ARI, fun((ARI, ARG) -> ARI)) -> list(ARI).
scan(List, Initial, Fun) ->
    do_scan(List, Initial, [], Fun).

-file("/var/www/build/packages/gleam_stdlib/src/gleam/list.gleam", 2162).
-spec last(list(ARK)) -> {ok, ARK} | {error, nil}.
last(List) ->
    _pipe = List,
    reduce(_pipe, fun(_, Elem) -> Elem end).

-file("/var/www/build/packages/gleam_stdlib/src/gleam/list.gleam", 2181).
...
-file("/var/www/build/packages/gleam_stdlib/src/gleam/list.gleam", 2199).
...
-file("/var/www/build/packages/gleam_stdlib/src/gleam/list.gleam", 2218).
-spec combination_pairs(list(ARW)) -> list({ARW, ARW}).
combination_pairs(Items) ->
    _pipe = do_combination_pairs(Items),
    flatten(_pipe).

-file("/var/www/build/packages/gleam_stdlib/src/gleam/list.gleam", 2250).
...
-file("/var/www/build/packages/gleam_stdlib/src/gleam/list.gleam", 2232).
-spec interleave(list(list(ARZ))) -> list(ARZ).
interleave(List) ->
    _pipe = transpose(List),
    flatten(_pipe).

-file("/var/www/build/packages/gleam_stdlib/src/gleam/list.gleam", 2273).
...
-file("/var/www/build/packages/gleam_stdlib/src/gleam/list.gleam", 2281).
...
-file("/var/www/build/packages/gleam_stdlib/src/gleam/list.gleam", 2300).
