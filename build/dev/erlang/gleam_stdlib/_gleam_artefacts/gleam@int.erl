...
-file("/var/www/build/packages/gleam_stdlib/src/gleam/int.gleam", 30).
...
-file("/var/www/build/packages/gleam_stdlib/src/gleam/int.gleam", 107).
-spec parse(binary()) -> {ok, integer()} | {error, nil}.
parse(String) ->
    gleam_stdlib:parse_int(String).

-file("/var/www/build/packages/gleam_stdlib/src/gleam/int.gleam", 145).
...
-file("/var/www/build/packages/gleam_stdlib/src/gleam/int.gleam", 165).
-spec to_string(integer()) -> binary().
to_string(X) ->
    erlang:integer_to_binary(X).

-file("/var/www/build/packages/gleam_stdlib/src/gleam/int.gleam", 204).
...
-file("/var/www/build/packages/gleam_stdlib/src/gleam/int.gleam", 224).
-spec to_base2(integer()) -> binary().
to_base2(X) ->
    erlang:integer_to_binary(X, 2).

-file("/var/www/build/packages/gleam_stdlib/src/gleam/int.gleam", 237).
-spec to_base8(integer()) -> binary().
to_base8(X) ->
    erlang:integer_to_binary(X, 8).

-file("/var/www/build/packages/gleam_stdlib/src/gleam/int.gleam", 250).
-spec to_base16(integer()) -> binary().
to_base16(X) ->
    erlang:integer_to_binary(X, 16).

-file("/var/www/build/packages/gleam_stdlib/src/gleam/int.gleam", 263).
-spec to_base36(integer()) -> binary().
to_base36(X) ->
    erlang:integer_to_binary(X, 36).

-file("/var/www/build/packages/gleam_stdlib/src/gleam/int.gleam", 286).
-spec to_float(integer()) -> float().
to_float(X) ->
    erlang:float(X).

-file("/var/www/build/packages/gleam_stdlib/src/gleam/int.gleam", 67).
...
-file("/var/www/build/packages/gleam_stdlib/src/gleam/int.gleam", 87).
...
-file("/var/www/build/packages/gleam_stdlib/src/gleam/int.gleam", 328).
...
-file("/var/www/build/packages/gleam_stdlib/src/gleam/int.gleam", 348).
...
-file("/var/www/build/packages/gleam_stdlib/src/gleam/int.gleam", 364).
...
-file("/var/www/build/packages/gleam_stdlib/src/gleam/int.gleam", 303).
...
-file("/var/www/build/packages/gleam_stdlib/src/gleam/int.gleam", 385).
-spec is_even(integer()) -> boolean().
is_even(X) ->
    (X rem 2) =:= 0.

-file("/var/www/build/packages/gleam_stdlib/src/gleam/int.gleam", 403).
-spec is_odd(integer()) -> boolean().
is_odd(X) ->
    (X rem 2) /= 0.

-file("/var/www/build/packages/gleam_stdlib/src/gleam/int.gleam", 416).
-spec negate(integer()) -> integer().
negate(X) ->
    -1 * X.

-file("/var/www/build/packages/gleam_stdlib/src/gleam/int.gleam", 434).
...
-file("/var/www/build/packages/gleam_stdlib/src/gleam/int.gleam", 429).
-spec sum(list(integer())) -> integer().
sum(Numbers) ->
    _pipe = Numbers,
    do_sum(_pipe, 0).

-file("/var/www/build/packages/gleam_stdlib/src/gleam/int.gleam", 457).
...
-file("/var/www/build/packages/gleam_stdlib/src/gleam/int.gleam", 450).
...
-file("/var/www/build/packages/gleam_stdlib/src/gleam/int.gleam", 486).
...
-file("/var/www/build/packages/gleam_stdlib/src/gleam/int.gleam", 479).
...
-file("/var/www/build/packages/gleam_stdlib/src/gleam/int.gleam", 520).
...
-file("/var/www/build/packages/gleam_stdlib/src/gleam/int.gleam", 513).
...
-file("/var/www/build/packages/gleam_stdlib/src/gleam/int.gleam", 549).
...
-file("/var/www/build/packages/gleam_stdlib/src/gleam/int.gleam", 582).
...
-file("/var/www/build/packages/gleam_stdlib/src/gleam/int.gleam", 634).
...
-file("/var/www/build/packages/gleam_stdlib/src/gleam/int.gleam", 676).
...
-file("/var/www/build/packages/gleam_stdlib/src/gleam/int.gleam", 720).
...
-file("/var/www/build/packages/gleam_stdlib/src/gleam/int.gleam", 754).
-spec add(integer(), integer()) -> integer().
add(A, B) ->
    A + B.

-file("/var/www/build/packages/gleam_stdlib/src/gleam/int.gleam", 782).
-spec multiply(integer(), integer()) -> integer().
multiply(A, B) ->
    A * B.

-file("/var/www/build/packages/gleam_stdlib/src/gleam/int.gleam", 815).
-spec subtract(integer(), integer()) -> integer().
subtract(A, B) ->
    A - B.

-file("/var/www/build/packages/gleam_stdlib/src/gleam/int.gleam", 827).
-spec bitwise_and(integer(), integer()) -> integer().
bitwise_and(X, Y) ->
    erlang:'band'(X, Y).

-file("/var/www/build/packages/gleam_stdlib/src/gleam/int.gleam", 837).
-spec bitwise_not(integer()) -> integer().
bitwise_not(X) ->
    erlang:'bnot'(X).

-file("/var/www/build/packages/gleam_stdlib/src/gleam/int.gleam", 847).
-spec bitwise_or(integer(), integer()) -> integer().
bitwise_or(X, Y) ->
    erlang:'bor'(X, Y).

-file("/var/www/build/packages/gleam_stdlib/src/gleam/int.gleam", 857).
-spec bitwise_exclusive_or(integer(), integer()) -> integer().
bitwise_exclusive_or(X, Y) ->
    erlang:'bxor'(X, Y).

-file("/var/www/build/packages/gleam_stdlib/src/gleam/int.gleam", 867).
-spec bitwise_shift_left(integer(), integer()) -> integer().
bitwise_shift_left(X, Y) ->
    erlang:'bsl'(X, Y).

-file("/var/www/build/packages/gleam_stdlib/src/gleam/int.gleam", 877).
