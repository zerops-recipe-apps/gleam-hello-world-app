...
-file("/var/www/build/packages/gleam_stdlib/src/gleam/string.gleam", 23).
-spec is_empty(binary()) -> boolean().
is_empty(Str) ->
    Str =:= <<""/utf8>>.

-file("/var/www/build/packages/gleam_stdlib/src/gleam/string.gleam", 49).
-spec length(binary()) -> integer().
length(String) ->
    string:length(String).

-file("/var/www/build/packages/gleam_stdlib/src/gleam/string.gleam", 73).
...
-file("/var/www/build/packages/gleam_stdlib/src/gleam/string.gleam", 69).
-spec reverse(binary()) -> binary().
reverse(String) ->
    do_reverse(String).

-file("/var/www/build/packages/gleam_stdlib/src/gleam/string.gleam", 94).
...
-file("/var/www/build/packages/gleam_stdlib/src/gleam/string.gleam", 117).
-spec lowercase(binary()) -> binary().
lowercase(String) ->
    string:lowercase(String).

-file("/var/www/build/packages/gleam_stdlib/src/gleam/string.gleam", 137).
-spec uppercase(binary()) -> binary().
uppercase(String) ->
    string:uppercase(String).

-file("/var/www/build/packages/gleam_stdlib/src/gleam/string.gleam", 161).
...
-file("/var/www/build/packages/gleam_stdlib/src/gleam/string.gleam", 206).
...
-file("/var/www/build/packages/gleam_stdlib/src/gleam/string.gleam", 239).
-spec crop(binary(), binary()) -> binary().
crop(String, Substring) ->
    gleam_stdlib:crop_string(String, Substring).

-file("/var/www/build/packages/gleam_stdlib/src/gleam/string.gleam", 250).
...
-file("/var/www/build/packages/gleam_stdlib/src/gleam/string.gleam", 266).
...
-file("/var/www/build/packages/gleam_stdlib/src/gleam/string.gleam", 294).
-spec contains(binary(), binary()) -> boolean().
contains(Haystack, Needle) ->
    gleam_stdlib:contains_string(Haystack, Needle).

-file("/var/www/build/packages/gleam_stdlib/src/gleam/string.gleam", 305).
-spec starts_with(binary(), binary()) -> boolean().
starts_with(String, Prefix) ->
    gleam_stdlib:string_starts_with(String, Prefix).

-file("/var/www/build/packages/gleam_stdlib/src/gleam/string.gleam", 322).
-spec ends_with(binary(), binary()) -> boolean().
ends_with(String, Suffix) ->
    gleam_stdlib:string_ends_with(String, Suffix).

-file("/var/www/build/packages/gleam_stdlib/src/gleam/string.gleam", 374).
...
-file("/var/www/build/packages/gleam_stdlib/src/gleam/string.gleam", 366).
-spec split_once(binary(), binary()) -> {ok, {binary(), binary()}} |
    {error, nil}.
split_once(String, Substring) ->
    do_split_once(String, Substring).

-file("/var/www/build/packages/gleam_stdlib/src/gleam/string.gleam", 400).
...
-file("/var/www/build/packages/gleam_stdlib/src/gleam/string.gleam", 420).
...
-file("/var/www/build/packages/gleam_stdlib/src/gleam/string.gleam", 441).
...
-file("/var/www/build/packages/gleam_stdlib/src/gleam/string.gleam", 437).
-spec repeat(binary(), integer()) -> binary().
repeat(String, Times) ->
    do_repeat(String, Times, <<""/utf8>>).

-file("/var/www/build/packages/gleam_stdlib/src/gleam/string.gleam", 464).
...
-file("/var/www/build/packages/gleam_stdlib/src/gleam/string.gleam", 459).
-spec join(list(binary()), binary()) -> binary().
join(Strings, Separator) ->
    do_join(Strings, Separator).

-file("/var/www/build/packages/gleam_stdlib/src/gleam/string.gleam", 536).
...
-file("/var/www/build/packages/gleam_stdlib/src/gleam/string.gleam", 489).
...
-file("/var/www/build/packages/gleam_stdlib/src/gleam/string.gleam", 522).
...
-file("/var/www/build/packages/gleam_stdlib/src/gleam/string.gleam", 558).
-spec do_trim(binary()) -> binary().
do_trim(String) ->
    string:trim(String, both).

-file("/var/www/build/packages/gleam_stdlib/src/gleam/string.gleam", 553).
-spec trim(binary()) -> binary().
trim(String) ->
    do_trim(String).

-file("/var/www/build/packages/gleam_stdlib/src/gleam/string.gleam", 585).
-spec do_trim_left(binary()) -> binary().
do_trim_left(String) ->
    string:trim(String, leading).

-file("/var/www/build/packages/gleam_stdlib/src/gleam/string.gleam", 580).
-spec trim_left(binary()) -> binary().
trim_left(String) ->
    do_trim_left(String).

-file("/var/www/build/packages/gleam_stdlib/src/gleam/string.gleam", 603).
-spec do_trim_right(binary()) -> binary().
do_trim_right(String) ->
    string:trim(String, trailing).

-file("/var/www/build/packages/gleam_stdlib/src/gleam/string.gleam", 598).
-spec trim_right(binary()) -> binary().
trim_right(String) ->
    do_trim_right(String).

-file("/var/www/build/packages/gleam_stdlib/src/gleam/string.gleam", 626).
-spec pop_grapheme(binary()) -> {ok, {binary(), binary()}} | {error, nil}.
pop_grapheme(String) ->
    gleam_stdlib:string_pop_grapheme(String).

-file("/var/www/build/packages/gleam_stdlib/src/gleam/string.gleam", 648).
...
-file("/var/www/build/packages/gleam_stdlib/src/gleam/string.gleam", 643).
-spec to_graphemes(binary()) -> list(binary()).
to_graphemes(String) ->
    _pipe = do_to_graphemes(String, []),
    lists:reverse(_pipe).

-file("/var/www/build/packages/gleam_stdlib/src/gleam/string.gleam", 339).
...
-file("/var/www/build/packages/gleam_stdlib/src/gleam/string.gleam", 696).
...
-file("/var/www/build/packages/gleam_stdlib/src/gleam/string.gleam", 690).
-spec do_to_utf_codepoints(binary()) -> list(integer()).
do_to_utf_codepoints(String) ->
    _pipe = do_to_utf_codepoints_impl(<<String/binary>>, []),
    lists:reverse(_pipe).

-file("/var/www/build/packages/gleam_stdlib/src/gleam/string.gleam", 685).
-spec to_utf_codepoints(binary()) -> list(integer()).
to_utf_codepoints(String) ->
    do_to_utf_codepoints(String).

-file("/var/www/build/packages/gleam_stdlib/src/gleam/string.gleam", 736).
...
-file("/var/www/build/packages/gleam_stdlib/src/gleam/string.gleam", 742).
...
-file("/var/www/build/packages/gleam_stdlib/src/gleam/string.gleam", 761).
-spec utf_codepoint_to_int(integer()) -> integer().
utf_codepoint_to_int(Cp) ->
    gleam_stdlib:identity(Cp).

-file("/var/www/build/packages/gleam_stdlib/src/gleam/string.gleam", 784).
...
-file("/var/www/build/packages/gleam_stdlib/src/gleam/string.gleam", 807).
...
-file("/var/www/build/packages/gleam_stdlib/src/gleam/string.gleam", 830).
...
-file("/var/www/build/packages/gleam_stdlib/src/gleam/string.gleam", 848).
...
-file("/var/www/build/packages/gleam_stdlib/src/gleam/string.gleam", 857).
-spec inspect(any()) -> binary().
inspect(Term) ->
    _pipe = gleam_stdlib:inspect(Term),
    gleam@string_builder:to_string(_pipe).

-file("/var/www/build/packages/gleam_stdlib/src/gleam/string.gleam", 880).
