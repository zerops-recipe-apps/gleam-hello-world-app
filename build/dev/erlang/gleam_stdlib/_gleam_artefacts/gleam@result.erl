...
-file("/var/www/build/packages/gleam_stdlib/src/gleam/result.gleam", 20).
...
-file("/var/www/build/packages/gleam_stdlib/src/gleam/result.gleam", 41).
...
-file("/var/www/build/packages/gleam_stdlib/src/gleam/result.gleam", 66).
...
-file("/var/www/build/packages/gleam_stdlib/src/gleam/result.gleam", 91).
...
-file("/var/www/build/packages/gleam_stdlib/src/gleam/result.gleam", 120).
...
-file("/var/www/build/packages/gleam_stdlib/src/gleam/result.gleam", 158).
...
-file("/var/www/build/packages/gleam_stdlib/src/gleam/result.gleam", 170).
...
-file("/var/www/build/packages/gleam_stdlib/src/gleam/result.gleam", 192).
...
-file("/var/www/build/packages/gleam_stdlib/src/gleam/result.gleam", 214).
...
-file("/var/www/build/packages/gleam_stdlib/src/gleam/result.gleam", 236).
...
-file("/var/www/build/packages/gleam_stdlib/src/gleam/result.gleam", 258).
...
-file("/var/www/build/packages/gleam_stdlib/src/gleam/result.gleam", 279).
-spec nil_error({ok, BZH} | {error, any()}) -> {ok, BZH} | {error, nil}.
nil_error(Result) ->
    map_error(Result, fun(_) -> nil end).

-file("/var/www/build/packages/gleam_stdlib/src/gleam/result.gleam", 307).
...
-file("/var/www/build/packages/gleam_stdlib/src/gleam/result.gleam", 340).
...
-file("/var/www/build/packages/gleam_stdlib/src/gleam/result.gleam", 366).
-spec all(list({ok, CAD} | {error, CAE})) -> {ok, list(CAD)} | {error, CAE}.
all(Results) ->
    gleam@list:try_map(Results, fun(X) -> X end).

-file("/var/www/build/packages/gleam_stdlib/src/gleam/result.gleam", 386).
...
-file("/var/www/build/packages/gleam_stdlib/src/gleam/result.gleam", 382).
-spec partition(list({ok, CAL} | {error, CAM})) -> {list(CAL), list(CAM)}.
partition(Results) ->
    do_partition(Results, [], []).

-file("/var/www/build/packages/gleam_stdlib/src/gleam/result.gleam", 408).
...
-file("/var/www/build/packages/gleam_stdlib/src/gleam/result.gleam", 429).
...
-file("/var/www/build/packages/gleam_stdlib/src/gleam/result.gleam", 445).
-spec values(list({ok, CBO} | {error, any()})) -> list(CBO).
values(Results) ->
    gleam@list:filter_map(Results, fun(R) -> R end).

-file("/var/www/build/packages/gleam_stdlib/src/gleam/result.gleam", 478).
-spec try_recover(
    {ok, CBU} | {error, CBV},
