...
-file("/var/www/build/packages/gleam_stdlib/src/gleam/dict.gleam", 36).
-spec size(dict(any(), any())) -> integer().
size(Dict) ->
    maps:size(Dict).

-file("/var/www/build/packages/gleam_stdlib/src/gleam/dict.gleam", 80).
-spec to_list(dict(KW, KX)) -> list({KW, KX}).
to_list(Dict) ->
    maps:to_list(Dict).

-file("/var/www/build/packages/gleam_stdlib/src/gleam/dict.gleam", 127).
-spec new() -> dict(any(), any()).
new() ->
    maps:new().

-file("/var/www/build/packages/gleam_stdlib/src/gleam/dict.gleam", 52).
-spec is_empty(dict(any(), any())) -> boolean().
is_empty(Dict) ->
    Dict =:= new().

-file("/var/www/build/packages/gleam_stdlib/src/gleam/dict.gleam", 152).
-spec get(dict(MD, ME), MD) -> {ok, ME} | {error, nil}.
get(From, Get) ->
    gleam_stdlib:map_get(From, Get).

-file("/var/www/build/packages/gleam_stdlib/src/gleam/dict.gleam", 116).
-spec has_key(dict(LN, any()), LN) -> boolean().
has_key(Dict, Key) ->
    maps:is_key(Key, Dict).

-file("/var/www/build/packages/gleam_stdlib/src/gleam/dict.gleam", 177).
-spec insert(dict(MP, MQ), MP, MQ) -> dict(MP, MQ).
insert(Dict, Key, Value) ->
    maps:put(Key, Value, Dict).

-file("/var/www/build/packages/gleam_stdlib/src/gleam/dict.gleam", 92).
...
-file("/var/www/build/packages/gleam_stdlib/src/gleam/dict.gleam", 88).
-spec from_list(list({LB, LC})) -> dict(LB, LC).
from_list(List) ->
    maps:from_list(List).

-file("/var/www/build/packages/gleam_stdlib/src/gleam/dict.gleam", 229).
...
-file("/var/www/build/packages/gleam_stdlib/src/gleam/dict.gleam", 236).
...
-file("/var/www/build/packages/gleam_stdlib/src/gleam/dict.gleam", 219).
-spec keys(dict(NP, any())) -> list(NP).
keys(Dict) ->
    maps:keys(Dict).

-file("/var/www/build/packages/gleam_stdlib/src/gleam/dict.gleam", 266).
...
-file("/var/www/build/packages/gleam_stdlib/src/gleam/dict.gleam", 256).
-spec values(dict(any(), OJ)) -> list(OJ).
values(Dict) ->
    maps:values(Dict).

-file("/var/www/build/packages/gleam_stdlib/src/gleam/dict.gleam", 335).
...
-file("/var/www/build/packages/gleam_stdlib/src/gleam/dict.gleam", 366).
-spec merge(dict(QG, QH), dict(QG, QH)) -> dict(QG, QH).
merge(Dict, New_entries) ->
    maps:merge(Dict, New_entries).

-file("/var/www/build/packages/gleam_stdlib/src/gleam/dict.gleam", 403).
-spec delete(dict(RJ, RK), RJ) -> dict(RJ, RK).
delete(Dict, Key) ->
    maps:remove(Key, Dict).

-file("/var/www/build/packages/gleam_stdlib/src/gleam/dict.gleam", 431).
...
-file("/var/www/build/packages/gleam_stdlib/src/gleam/dict.gleam", 461).
...
-file("/var/www/build/packages/gleam_stdlib/src/gleam/dict.gleam", 473).
...
-file("/var/www/build/packages/gleam_stdlib/src/gleam/dict.gleam", 505).
...
-file("/var/www/build/packages/gleam_stdlib/src/gleam/dict.gleam", 196).
-spec map_values(dict(NB, NC), fun((NB, NC) -> NF)) -> dict(NB, NF).
map_values(Dict, Fun) ->
    maps:map(Fun, Dict).

-file("/var/www/build/packages/gleam_stdlib/src/gleam/dict.gleam", 290).
-spec filter(dict(OX, OY), fun((OX, OY) -> boolean())) -> dict(OX, OY).
filter(Dict, Predicate) ->
    maps:filter(Predicate, Dict).

-file("/var/www/build/packages/gleam_stdlib/src/gleam/dict.gleam", 537).
...
-file("/var/www/build/packages/gleam_stdlib/src/gleam/dict.gleam", 558).
