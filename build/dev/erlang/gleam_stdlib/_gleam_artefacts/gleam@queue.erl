...
-file("/var/www/build/packages/gleam_stdlib/src/gleam/queue.gleam", 22).
-spec new() -> queue(any()).
new() ->
    {queue, [], []}.

-file("/var/www/build/packages/gleam_stdlib/src/gleam/queue.gleam", 38).
-spec from_list(list(EXL)) -> queue(EXL).
from_list(List) ->
    {queue, [], List}.

-file("/var/www/build/packages/gleam_stdlib/src/gleam/queue.gleam", 54).
-spec to_list(queue(EXO)) -> list(EXO).
to_list(Queue) ->
    _pipe = erlang:element(3, Queue),
    lists:append(_pipe, lists:reverse(erlang:element(2, Queue))).

-file("/var/www/build/packages/gleam_stdlib/src/gleam/queue.gleam", 80).
-spec is_empty(queue(any())) -> boolean().
is_empty(Queue) ->
    (erlang:element(2, Queue) =:= []) andalso (erlang:element(3, Queue) =:= []).

-file("/var/www/build/packages/gleam_stdlib/src/gleam/queue.gleam", 106).
...
-file("/var/www/build/packages/gleam_stdlib/src/gleam/queue.gleam", 203).
...
-file("/var/www/build/packages/gleam_stdlib/src/gleam/queue.gleam", 236).
-spec reverse(queue(EYL)) -> queue(EYL).
reverse(Queue) ->
    {queue, erlang:element(3, Queue), erlang:element(2, Queue)}.

-file("/var/www/build/packages/gleam_stdlib/src/gleam/queue.gleam", 240).
-spec check_equal(
    list(EYO),
    list(EYO),
    list(EYO),
...
-file("/var/www/build/packages/gleam_stdlib/src/gleam/queue.gleam", 271).
...
-file("/var/www/build/packages/gleam_stdlib/src/gleam/queue.gleam", 288).
