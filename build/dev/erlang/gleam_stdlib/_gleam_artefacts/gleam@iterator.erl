...
-file("/var/www/build/packages/gleam_stdlib/src/gleam/iterator.gleam", 37).
-spec stop() -> action(any()).
stop() ->
    stop.

-file("/var/www/build/packages/gleam_stdlib/src/gleam/iterator.gleam", 42).
...
-file("/var/www/build/packages/gleam_stdlib/src/gleam/iterator.gleam", 75).
...
-file("/var/www/build/packages/gleam_stdlib/src/gleam/iterator.gleam", 94).
-spec repeatedly(fun(() -> DTQ)) -> iterator(DTQ).
repeatedly(F) ->
    unfold(nil, fun(_) -> {next, F(), nil} end).

-file("/var/www/build/packages/gleam_stdlib/src/gleam/iterator.gleam", 109).
-spec repeat(DTS) -> iterator(DTS).
repeat(X) ->
    repeatedly(fun() -> X end).

-file("/var/www/build/packages/gleam_stdlib/src/gleam/iterator.gleam", 123).
...
-file("/var/www/build/packages/gleam_stdlib/src/gleam/iterator.gleam", 134).
-spec do_transform(
    fun(() -> action(DTX)),
    DTZ,
...
-file("/var/www/build/packages/gleam_stdlib/src/gleam/iterator.gleam", 169).
...
-file("/var/www/build/packages/gleam_stdlib/src/gleam/iterator.gleam", 178).
...
-file("/var/www/build/packages/gleam_stdlib/src/gleam/iterator.gleam", 206).
...
-file("/var/www/build/packages/gleam_stdlib/src/gleam/iterator.gleam", 220).
-spec run(iterator(any())) -> nil.
run(Iterator) ->
    fold(Iterator, nil, fun(_, _) -> nil end).

-file("/var/www/build/packages/gleam_stdlib/src/gleam/iterator.gleam", 238).
...
-file("/var/www/build/packages/gleam_stdlib/src/gleam/iterator.gleam", 266).
...
-file("/var/www/build/packages/gleam_stdlib/src/gleam/iterator.gleam", 273).
...
-file("/var/www/build/packages/gleam_stdlib/src/gleam/iterator.gleam", 306).
...
-file("/var/www/build/packages/gleam_stdlib/src/gleam/iterator.gleam", 312).
...
-file("/var/www/build/packages/gleam_stdlib/src/gleam/iterator.gleam", 348).
-spec drop(iterator(DVK), integer()) -> iterator(DVK).
drop(Iterator, Desired) ->
    _pipe = fun() -> do_drop(erlang:element(2, Iterator), Desired) end,
    {iterator, _pipe}.

-file("/var/www/build/packages/gleam_stdlib/src/gleam/iterator.gleam", 353).
...
-file("/var/www/build/packages/gleam_stdlib/src/gleam/iterator.gleam", 379).
...
-file("/var/www/build/packages/gleam_stdlib/src/gleam/iterator.gleam", 385).
-spec do_map2(
    fun(() -> action(DVV)),
    fun(() -> action(DVX)),
    fun((DVV, DVX) -> DVZ)
...
-file("/var/www/build/packages/gleam_stdlib/src/gleam/iterator.gleam", 426).
...
-file("/var/www/build/packages/gleam_stdlib/src/gleam/iterator.gleam", 435).
...
-file("/var/www/build/packages/gleam_stdlib/src/gleam/iterator.gleam", 456).
...
-file("/var/www/build/packages/gleam_stdlib/src/gleam/iterator.gleam", 461).
...
-file("/var/www/build/packages/gleam_stdlib/src/gleam/iterator.gleam", 484).
-spec flatten(iterator(iterator(DWT))) -> iterator(DWT).
flatten(Iterator) ->
    _pipe = fun() -> do_flatten(erlang:element(2, Iterator)) end,
    {iterator, _pipe}.

-file("/var/www/build/packages/gleam_stdlib/src/gleam/iterator.gleam", 504).
-spec concat(list(iterator(DWX))) -> iterator(DWX).
concat(Iterators) ->
    flatten(from_list(Iterators)).

-file("/var/www/build/packages/gleam_stdlib/src/gleam/iterator.gleam", 526).
...
-file("/var/www/build/packages/gleam_stdlib/src/gleam/iterator.gleam", 535).
...
-file("/var/www/build/packages/gleam_stdlib/src/gleam/iterator.gleam", 568).
...
-file("/var/www/build/packages/gleam_stdlib/src/gleam/iterator.gleam", 576).
-spec do_filter_map(
    fun(() -> action(DXM)),
...
-file("/var/www/build/packages/gleam_stdlib/src/gleam/iterator.gleam", 612).
...
-file("/var/www/build/packages/gleam_stdlib/src/gleam/iterator.gleam", 632).
-spec cycle(iterator(DYA)) -> iterator(DYA).
cycle(Iterator) ->
    _pipe = repeat(Iterator),
    flatten(_pipe).

-file("/var/www/build/packages/gleam_stdlib/src/gleam/iterator.gleam", 678).
...
-file("/var/www/build/packages/gleam_stdlib/src/gleam/iterator.gleam", 712).
-spec find(iterator(DYI), fun((DYI) -> boolean())) -> {ok, DYI} | {error, nil}.
find(Haystack, Is_desired) ->
    _pipe = erlang:element(2, Haystack),
    do_find(_pipe, Is_desired).

-file("/var/www/build/packages/gleam_stdlib/src/gleam/iterator.gleam", 720).
-spec do_find_map(
    fun(() -> action(DYM)),
...
-file("/var/www/build/packages/gleam_stdlib/src/gleam/iterator.gleam", 757).
...
-file("/var/www/build/packages/gleam_stdlib/src/gleam/iterator.gleam", 765).
...
-file("/var/www/build/packages/gleam_stdlib/src/gleam/iterator.gleam", 787).
...
-file("/var/www/build/packages/gleam_stdlib/src/gleam/iterator.gleam", 802).
-spec iterate(DZI, fun((DZI) -> DZI)) -> iterator(DZI).
iterate(Initial, F) ->
    unfold(Initial, fun(Element) -> {next, Element, F(Element)} end).

-file("/var/www/build/packages/gleam_stdlib/src/gleam/iterator.gleam", 809).
...
-file("/var/www/build/packages/gleam_stdlib/src/gleam/iterator.gleam", 836).
...
-file("/var/www/build/packages/gleam_stdlib/src/gleam/iterator.gleam", 845).
...
-file("/var/www/build/packages/gleam_stdlib/src/gleam/iterator.gleam", 871).
...
-file("/var/www/build/packages/gleam_stdlib/src/gleam/iterator.gleam", 879).
...
-file("/var/www/build/packages/gleam_stdlib/src/gleam/iterator.gleam", 909).
...
-file("/var/www/build/packages/gleam_stdlib/src/gleam/iterator.gleam", 919).
...
-file("/var/www/build/packages/gleam_stdlib/src/gleam/iterator.gleam", 948).
-spec zip(iterator(EAJ), iterator(EAL)) -> iterator({EAJ, EAL}).
zip(Left, Right) ->
    _pipe = do_zip(erlang:element(2, Left), erlang:element(2, Right)),
    {iterator, _pipe}.

-file("/var/www/build/packages/gleam_stdlib/src/gleam/iterator.gleam", 959).
...
-file("/var/www/build/packages/gleam_stdlib/src/gleam/iterator.gleam", 977).
...
-file("/var/www/build/packages/gleam_stdlib/src/gleam/iterator.gleam", 1002).
...
-file("/var/www/build/packages/gleam_stdlib/src/gleam/iterator.gleam", 1022).
...
-file("/var/www/build/packages/gleam_stdlib/src/gleam/iterator.gleam", 1043).
...
-file("/var/www/build/packages/gleam_stdlib/src/gleam/iterator.gleam", 1080).
...
-file("/var/www/build/packages/gleam_stdlib/src/gleam/iterator.gleam", 1089).
...
-file("/var/www/build/packages/gleam_stdlib/src/gleam/iterator.gleam", 1128).
...
-file("/var/www/build/packages/gleam_stdlib/src/gleam/iterator.gleam", 1141).
...
-file("/var/www/build/packages/gleam_stdlib/src/gleam/iterator.gleam", 1182).
-spec any(iterator(EBY), fun((EBY) -> boolean())) -> boolean().
any(Iterator, Predicate) ->
    _pipe = erlang:element(2, Iterator),
    do_any(_pipe, Predicate).

-file("/var/www/build/packages/gleam_stdlib/src/gleam/iterator.gleam", 1190).
...
-file("/var/www/build/packages/gleam_stdlib/src/gleam/iterator.gleam", 1231).
-spec all(iterator(ECC), fun((ECC) -> boolean())) -> boolean().
all(Iterator, Predicate) ->
    _pipe = erlang:element(2, Iterator),
    do_all(_pipe, Predicate).

-file("/var/www/build/packages/gleam_stdlib/src/gleam/iterator.gleam", 1239).
...
-file("/var/www/build/packages/gleam_stdlib/src/gleam/iterator.gleam", 1248).
...
-file("/var/www/build/packages/gleam_stdlib/src/gleam/iterator.gleam", 1270).
...
-file("/var/www/build/packages/gleam_stdlib/src/gleam/iterator.gleam", 1300).
...
-file("/var/www/build/packages/gleam_stdlib/src/gleam/iterator.gleam", 1330).
-spec last(iterator(EDA)) -> {ok, EDA} | {error, nil}.
last(Iterator) ->
    _pipe = Iterator,
    reduce(_pipe, fun(_, Elem) -> Elem end).

-file("/var/www/build/packages/gleam_stdlib/src/gleam/iterator.gleam", 1344).
-spec empty() -> iterator(any()).
empty() ->
    {iterator, fun stop/0}.

-file("/var/www/build/packages/gleam_stdlib/src/gleam/iterator.gleam", 1357).
-spec once(fun(() -> EDG)) -> iterator(EDG).
once(F) ->
    _pipe = fun() -> {continue, F(), fun stop/0} end,
    {iterator, _pipe}.

-file("/var/www/build/packages/gleam_stdlib/src/gleam/iterator.gleam", 657).
...
-file("/var/www/build/packages/gleam_stdlib/src/gleam/iterator.gleam", 1371).
-spec single(EDI) -> iterator(EDI).
single(Elem) ->
    once(fun() -> Elem end).

-file("/var/www/build/packages/gleam_stdlib/src/gleam/iterator.gleam", 1375).
...
-file("/var/www/build/packages/gleam_stdlib/src/gleam/iterator.gleam", 1405).
...
-file("/var/www/build/packages/gleam_stdlib/src/gleam/iterator.gleam", 1413).
-spec do_fold_until(
    fun(() -> action(EDS)),
...
-file("/var/www/build/packages/gleam_stdlib/src/gleam/iterator.gleam", 1452).
-spec fold_until(
    iterator(EDW),
    EDY,
...
-file("/var/www/build/packages/gleam_stdlib/src/gleam/iterator.gleam", 1461).
-spec do_try_fold(
    fun(() -> action(EEA)),
...
-file("/var/www/build/packages/gleam_stdlib/src/gleam/iterator.gleam", 1496).
...
-file("/var/www/build/packages/gleam_stdlib/src/gleam/iterator.gleam", 1519).
...
-file("/var/www/build/packages/gleam_stdlib/src/gleam/iterator.gleam", 1549).
...
-file("/var/www/build/packages/gleam_stdlib/src/gleam/iterator.gleam", 1555).
...
-file("/var/www/build/packages/gleam_stdlib/src/gleam/iterator.gleam", 1579).
-spec length(iterator(any())) -> integer().
length(Iterator) ->
    _pipe = erlang:element(2, Iterator),
    do_length(_pipe, 0).

-file("/var/www/build/packages/gleam_stdlib/src/gleam/iterator.gleam", 1601).
...
-file("/var/www/build/packages/gleam_stdlib/src/gleam/iterator.gleam", 1626).
