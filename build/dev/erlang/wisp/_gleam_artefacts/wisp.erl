...
-file("/var/www/build/packages/wisp/src/wisp.gleam", 78).
-spec response(integer()) -> gleam@http@response:response(body()).
response(Status) ->
    {response, Status, [], empty}.

-file("/var/www/build/packages/wisp/src/wisp.gleam", 92).
...
-file("/var/www/build/packages/wisp/src/wisp.gleam", 122).
...
-file("/var/www/build/packages/wisp/src/wisp.gleam", 158).
...
-file("/var/www/build/packages/wisp/src/wisp.gleam", 185).
...
-file("/var/www/build/packages/wisp/src/wisp.gleam", 206).
...
-file("/var/www/build/packages/wisp/src/wisp.gleam", 228).
-spec html_body(
    gleam@http@response:response(body()),
...
-file("/var/www/build/packages/wisp/src/wisp.gleam", 248).
-spec json_body(
    gleam@http@response:response(body()),
    gleam@string_builder:string_builder()
) -> gleam@http@response:response(body()).
...
-file("/var/www/build/packages/wisp/src/wisp.gleam", 268).
...
-file("/var/www/build/packages/wisp/src/wisp.gleam", 294).
...
-file("/var/www/build/packages/wisp/src/wisp.gleam", 451).
...
-file("/var/www/build/packages/wisp/src/wisp.gleam", 610).
-spec unprocessable_entity() -> gleam@http@response:response(body()).
unprocessable_entity() ->
    {response, 422, [], empty}.

-file("/var/www/build/packages/wisp/src/wisp.gleam", 623).
-spec internal_server_error() -> gleam@http@response:response(body()).
internal_server_error() ->
    {response, 500, [], empty}.

-file("/var/www/build/packages/wisp/src/wisp.gleam", 647).
...
-file("/var/www/build/packages/wisp/src/wisp.gleam", 655).
...
-file("/var/www/build/packages/wisp/src/wisp.gleam", 662).
...
-file("/var/www/build/packages/wisp/src/wisp.gleam", 682).
...
-file("/var/www/build/packages/wisp/src/wisp.gleam", 689).
...
-file("/var/www/build/packages/wisp/src/wisp.gleam", 703).
...
-file("/var/www/build/packages/wisp/src/wisp.gleam", 714).
...
-file("/var/www/build/packages/wisp/src/wisp.gleam", 728).
...
-file("/var/www/build/packages/wisp/src/wisp.gleam", 736).
...
-file("/var/www/build/packages/wisp/src/wisp.gleam", 748).
...
-file("/var/www/build/packages/wisp/src/wisp.gleam", 756).
...
-file("/var/www/build/packages/wisp/src/wisp.gleam", 778).
-spec require_method(
...
-file("/var/www/build/packages/wisp/src/wisp.gleam", 823).
...
-file("/var/www/build/packages/wisp/src/wisp.gleam", 851).
-spec method_override(gleam@http@request:request(XDW)) -> gleam@http@request:request(XDW).
...
-file("/var/www/build/packages/wisp/src/wisp.gleam", 960).
-spec read_body_loop(
    fun((integer()) -> {ok, wisp@internal:read()} | {error, nil}),
    integer(),
    integer(),
...
-file("/var/www/build/packages/wisp/src/wisp.gleam", 950).
...
-file("/var/www/build/packages/wisp/src/wisp.gleam", 924).
...
-file("/var/www/build/packages/wisp/src/wisp.gleam", 1050).
...
-file("/var/www/build/packages/wisp/src/wisp.gleam", 1183).
...
-file("/var/www/build/packages/wisp/src/wisp.gleam", 1249).
-spec fn_with_bad_request_error(fun((XEX) -> {ok, XEY} | {error, any()})) -> fun((XEX) -> {ok,
        XEY} |
    {error, gleam@http@response:response(body())}).
...
-file("/var/www/build/packages/wisp/src/wisp.gleam", 1258).
...
-file("/var/www/build/packages/wisp/src/wisp.gleam", 1272).
...
-file("/var/www/build/packages/wisp/src/wisp.gleam", 1207).
-spec multipart_body(
    buffered_reader(),
    ...
    integer(),
    integer(),
    fun((XER, bitstring()) -> {ok, XER} |
        {error, gleam@http@response:response(body())}),
    XER
) -> {ok, {gleam@option:option(buffered_reader()), integer(), XER}} |
    {error, gleam@http@response:response(body())}.
...
-file("/var/www/build/packages/wisp/src/wisp.gleam", 1286).
...
-file("/var/www/build/packages/wisp/src/wisp.gleam", 1313).
-spec sort_keys(list({binary(), XFP})) -> list({binary(), XFP}).
sort_keys(Pairs) ->
    gleam@list:sort(
        Pairs,
        fun(A, B) ->
...
-file("/var/www/build/packages/wisp/src/wisp.gleam", 1317).
-spec or_400(
    {ok, XFS} | {error, any()},
    fun((XFS) -> gleam@http@response:response(body()))
) -> gleam@http@response:response(body()).
or_400(Result, Next) ->
    case Result of
        {ok, Value} ->
...
-file("/var/www/build/packages/wisp/src/wisp.gleam", 891).
...
-file("/var/www/build/packages/wisp/src/wisp.gleam", 1092).
-spec require_json(
    gleam@http@request:request(wisp@internal:connection()),
...
-file("/var/www/build/packages/wisp/src/wisp.gleam", 1099).
...
-file("/var/www/build/packages/wisp/src/wisp.gleam", 1466).
-spec serve_static(
    gleam@http@request:request(wisp@internal:connection()),
    binary(),
    binary(),
...
-file("/var/www/build/packages/wisp/src/wisp.gleam", 1523).
-spec handle_head(
    gleam@http@request:request(wisp@internal:connection()),
...
-file("/var/www/build/packages/wisp/src/wisp.gleam", 1549).
...
-file("/var/www/build/packages/wisp/src/wisp.gleam", 1565).
...
-file("/var/www/build/packages/wisp/src/wisp.gleam", 1600).
-spec configure_logger() -> nil.
configure_logger() ->
    logging_ffi:configure().

-file("/var/www/build/packages/wisp/src/wisp.gleam", 1621).
...
-file("/var/www/build/packages/wisp/src/wisp.gleam", 1640).
-spec set_logger_level(log_level()) -> nil.
set_logger_level(Log_level) ->
    logging:set_level(log_level_to_logging_log_level(Log_level)).

-file("/var/www/build/packages/wisp/src/wisp.gleam", 1650).
-spec log_emergency(binary()) -> nil.
log_emergency(Message) ->
    logging:log(emergency, Message).

-file("/var/www/build/packages/wisp/src/wisp.gleam", 1660).
-spec log_alert(binary()) -> nil.
log_alert(Message) ->
    logging:log(alert, Message).

-file("/var/www/build/packages/wisp/src/wisp.gleam", 1670).
-spec log_critical(binary()) -> nil.
log_critical(Message) ->
    logging:log(critical, Message).

-file("/var/www/build/packages/wisp/src/wisp.gleam", 1680).
-spec log_error(binary()) -> nil.
log_error(Message) ->
    logging:log(error, Message).

-file("/var/www/build/packages/wisp/src/wisp.gleam", 1197).
-spec or_500({ok, XEJ} | {error, any()}) -> {ok, XEJ} |
    {error, gleam@http@response:response(body())}.
or_500(Result) ->
    case Result of
        {ok, Value} ->
...
-file("/var/www/build/packages/wisp/src/wisp.gleam", 1188).
...
-file("/var/www/build/packages/wisp/src/wisp.gleam", 1126).
-spec read_multipart(
    gleam@http@request:request(wisp@internal:connection()),
    buffered_reader(),
    binary(),
...
-file("/var/www/build/packages/wisp/src/wisp.gleam", 1109).
...
-file("/var/www/build/packages/wisp/src/wisp.gleam", 1016).
-spec require_form(
    gleam@http@request:request(wisp@internal:connection()),
    fun((form_data()) -> gleam@http@response:response(body()))
) -> gleam@http@response:response(body()).
...
-file("/var/www/build/packages/wisp/src/wisp.gleam", 1363).
...
-file("/var/www/build/packages/wisp/src/wisp.gleam", 1690).
-spec log_warning(binary()) -> nil.
log_warning(Message) ->
    logging:log(warning, Message).

-file("/var/www/build/packages/wisp/src/wisp.gleam", 1700).
-spec log_notice(binary()) -> nil.
log_notice(Message) ->
    logging:log(notice, Message).

-file("/var/www/build/packages/wisp/src/wisp.gleam", 1710).
-spec log_info(binary()) -> nil.
log_info(Message) ->
    logging:log(info, Message).

-file("/var/www/build/packages/wisp/src/wisp.gleam", 1411).
-spec log_request(
    gleam@http@request:request(wisp@internal:connection()),
    fun(() -> gleam@http@response:response(body()))
) -> gleam@http@response:response(body()).
...
-file("/var/www/build/packages/wisp/src/wisp.gleam", 1720).
-spec log_debug(binary()) -> nil.
log_debug(Message) ->
    logging:log(debug, Message).

-file("/var/www/build/packages/wisp/src/wisp.gleam", 1730).
-spec random_string(integer()) -> binary().
random_string(Length) ->
    wisp@internal:random_string(Length).

-file("/var/www/build/packages/wisp/src/wisp.gleam", 1743).
-spec sign_message(
    gleam@http@request:request(wisp@internal:connection()),
    bitstring(),
...
-file("/var/www/build/packages/wisp/src/wisp.gleam", 1759).
...
-file("/var/www/build/packages/wisp/src/wisp.gleam", 1800).
-spec set_cookie(
    gleam@http@response:response(body()),
    gleam@http@request:request(wisp@internal:connection()),
    binary(),
...
-file("/var/www/build/packages/wisp/src/wisp.gleam", 1841).
-spec get_cookie(
    gleam@http@request:request(wisp@internal:connection()),
    binary(),
    security()
...
-file("/var/www/build/packages/wisp/src/wisp.gleam", 1868).
...
-file("/var/www/build/packages/wisp/src/wisp.gleam", 372).
...
-file("/var/www/build/packages/wisp/src/wisp.gleam", 337).
...
-file("/var/www/build/packages/wisp/src/wisp.gleam", 311).
